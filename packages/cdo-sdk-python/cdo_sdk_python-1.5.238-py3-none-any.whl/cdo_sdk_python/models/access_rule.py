...
class AccessRule(BaseModel):
    ...
    issue: Optional[StrictStr] = Field(default=None, description="Indicates if rule has SHADOWED issue.")
    ...
    __properties: ClassVar[List[str]] = ["accessGroupUid", "createdDate", "destinationDynamicObject", "destinationNetwork", "destinationPort", "entityUid", "index", "isActiveRule", "issue", "logSettings", "protocol", "remark", "ruleAction", "ruleConfigurationLineNumber", "ruleConfigurationText", "ruleParsingError", "ruleTimeRange", "ruleType", "sharedAccessGroupUid", "sourceDynamicObject", "sourceNetwork", "sourcePort", "uid", "updatedDate"]
