...
@register_client()
class FileManagerClient(QbraidClient):
    ...
    def upload_file(
        ...
        Args:
            ...
            namespace (str, optional): The qBraid namespace, or top-level container, in which
                to upload the file. Defaults to FileManagerClient.default_namespace.
        ...
        Raises:
            FileManagementServiceRequestError: If the file upload request fails.
        ...
        try:
            ...
            raise FileManagementServiceRequestError(f"Failed to upload file: {err}") from err
        except JSONDecodeError as err:
            raise FileManagementServiceRequestError(
    ...
    def download_file(
        ...
        Args:
            ...
            namespace (str, optional): The qBraid namespace, or top-level container, from which
                to download the file. Defaults to FileManagerClient.default_namespace.
        ...
        Raises:
            FileManagementServiceRequestError: If the file download request fails.
        ...
        try:
            ...
            raise FileManagementServiceRequestError(f"Failed to download file: {err}") from err
