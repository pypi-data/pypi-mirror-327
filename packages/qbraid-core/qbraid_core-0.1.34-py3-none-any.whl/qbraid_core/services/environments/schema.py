...
class EnvironmentConfig(BaseModel):
    ...
    @classmethod
    def _check_python_version(cls, value):
        if value is None:
            return value
    ...
    @classmethod
    def _check_package_versions(cls, value):
        if value is None:
            return value
    ...
    @classmethod
    def _serialize_package_versions(cls, value):
        if value is None:
            return value
    ...
    @classmethod
    def from_yaml(cls, file_path: str) -> "EnvironmentConfig":
