...
const ExternalBucketSearchComponent = ({ show, handleClose }) => {
    ...
    const onSubmit = async (values) => {
        ...
        if (response.status_code === 200) {
            ...
            jupyterlab_toastify__WEBPACK_IMPORTED_MODULE_1__.INotification.error((_a = response.error) === null || _a === void 0 ? void 0 : _a.message, { autoClose: 5000 });
            handleClose();
        }
    };
    ...
    const customAddToFavorites = (0,chonky_navteca__WEBPACK_IMPORTED_MODULE_0__.defineFileAction)({
        ...
        if (state.contextMenuTriggerFile) {
            if ((state.selectedFiles[0].hasOwnProperty('isDir')) && (folderPrefix === '/')) {
                let newFavorite = {
                    path: folderChain.length === 1 ? state.contextMenuTriggerFile.id : `${(_a = folderChain[1]) === null || _a === void 0 ? void 0 : _a.id}/${state.contextMenuTriggerFile.id}`,
                ...
                if (response.status_code === 200) {
                    ...
                    jupyterlab_toastify__WEBPACK_IMPORTED_MODULE_4__.INotification.error((_b = response.error) === null || _b === void 0 ? void 0 : _b.message, { autoClose: 5000 });
                }
            }
            else {
    ...
    const customRemoveFromFavorite = (0,chonky_navteca__WEBPACK_IMPORTED_MODULE_0__.defineFileAction)({
        ...
        if (isRoot && state.contextMenuTriggerFile) {
            ...
            if (response.status_code === 200) {
                ...
                jupyterlab_toastify__WEBPACK_IMPORTED_MODULE_4__.INotification.error((_a = response.error) === null || _a === void 0 ? void 0 : _a.message, { autoClose: 5000 });
            }
        }
    });
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'dropdown' },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap_Dropdown__WEBPACK_IMPORTED_MODULE_2__["default"], null,
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap_Dropdown__WEBPACK_IMPORTED_MODULE_2__["default"].Menu, null, openDataSources.map((e, index) => {
                return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap_Dropdown__WEBPACK_IMPORTED_MODULE_2__["default"].Item, { key: e + "-" + index, onClick: () => {
                        setODSource(e);
                        setSelectedSource(e);
                    }, disabled: e != 'AWS' }, e));
            })))));
...
//# sourceMappingURL=lib_index_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_viewBox_27-4_-4_8_8-ab17c1.4f0174e37ac29151ed79.js.map