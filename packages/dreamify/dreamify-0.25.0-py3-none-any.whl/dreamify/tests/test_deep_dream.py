...
from dreamify.deep_dream import deep_dream_simple, deep_dream_octaved
...
@pytest.mark.parametrize("deepdream_inputs", [100], indirect=True)
...
@pytest.mark.parametrize("deepdream_inputs", [50], indirect=True)
