...
@pytest.mark.parametrize("fieldName, expectedValue", [
	...
	("identifiers", [{'type': 'url',
					 'value': 'https://github.com/hunterhogan/mapFolding/releases/tag/0.3.9',
					 'description': 'The URL for mapFolding 0.3.9.'}]),
	("keywords", ['A001415', 'A001416', 'A001417', 'A001418', 'A195646',
				 'folding', 'map folding', 'OEIS', 'stamp folding']),
...
def test_addCitation_fields(nexusCitationTesting, citationAlphaDOTcff: pathlib.Path,
						  fieldName: str, expectedValue: str):
