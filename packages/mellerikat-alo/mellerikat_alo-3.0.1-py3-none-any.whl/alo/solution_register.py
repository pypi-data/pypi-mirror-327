...
class SolutionRegister:
    ...
    def _set_alo(self):
        ...
        if settings.experimental_plan.solution.train and settings.experimental_plan.solution.train.artifact_uri:
        ...
        if settings.experimental_plan.solution.inference and settings.experimental_plan.solution.inference.artifact_uri:
            ...
            for uri_type in ['dataset_uri', 'model_uri']:
                ...
                for local_file in local_files:
                    ...
                    if not os.path.isabs(local_file.path):
                        replace_files.append(local_file.url())
                        continue
                    target_path = os.path.join(REGISTER_SOLUTION_PATH, os.path.basename(local_file.path.rstrip(os.sep))) + (os.sep if os.path.isdir(local_file.path.rstrip(os.sep)) else "")
