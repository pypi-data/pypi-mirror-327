...
from connector.generated.models.get_last_activity import GetLastActivity
from connector.generated.models.page import Page
from typing import Optional, Set
from typing_extensions import Self

class GetLastActivityRequest(BaseModel):
    """
    Authenticated request.
    """ # noqa: E501
    auth: Optional[AuthCredential] = None
    credentials: Optional[List[AuthCredential]] = None
    request: GetLastActivity = Field(description="The main request payload.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetLastActivityRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetLastActivityRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "request": GetLastActivity.from_dict(obj["request"]) if obj.get("request") is not None else None,
