...
class JWTHeaders(BaseModel):
    ...
    JWT headers model.
    """ # noqa: E501
    alg: Optional[StrictStr] = Field(default=None, description="The JWT algorithm.")
    jku: Optional[StrictStr] = Field(default=None, description="JWK Set URL.")
    jwk: Optional[StrictStr] = Field(default=None, description="JWK.")
    typ: Optional[StrictStr] = Field(default=None, description="The JWT type.")
    kid: Optional[StrictStr] = Field(default=None, description="The JWT key ID.")
    x5u: Optional[StrictStr] = Field(default=None, description="The X509 URL.")
    x5c: Optional[StrictStr] = Field(default=None, description="The X509 certificate chain.")
    x5t: Optional[StrictStr] = Field(default=None, description="The X509 certificate SHA-1 thumbprint.")
    x5t_s256: Optional[StrictStr] = Field(default=None, description="The X509 certificate SHA-256 thumbprint.", alias="x5t#S256")
    cty: Optional[StrictStr] = Field(default=None, description="The content type of the JWT.")
    crit: Optional[List[StrictStr]] = Field(default=None, description="The JWT critical extension.")
    __properties: ClassVar[List[str]] = ["alg", "jku", "jwk", "typ", "kid", "x5u", "x5c", "x5t", "x5t#S256", "cty", "crit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JWTHeaders from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JWTHeaders from a dict"""
        if obj is None:
            return None
