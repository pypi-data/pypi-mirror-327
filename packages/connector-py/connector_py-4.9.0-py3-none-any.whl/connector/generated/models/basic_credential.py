...
from connector.serializers.request import SecretField
...
class BasicCredential(BaseModel):
    ...
    password: StrictStr = SecretField(description="The password for basic auth.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BasicCredential from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BasicCredential from a dict"""
        if obj is None:
            return None
