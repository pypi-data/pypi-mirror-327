...
class UnassignEntitlement(BaseModel):
    ...
    """ # noqa: E501
    account_integration_specific_id: StrictStr = Field(description="The integration-specific identifier for the user account")
    resource_type: StrictStr = Field(description="Should match a previously declared resource type from this connector")
    resource_integration_specific_id: StrictStr = Field(description="The integration-specific identifier for the resource")
    entitlement_type: StrictStr = Field(description="Should match a previously declared entitlement type from this connector")
    entitlement_integration_specific_id: StrictStr = Field(description="The integration-specific identifier for the entitlement")
    __properties: ClassVar[List[str]] = ["account_integration_specific_id", "resource_type", "resource_integration_specific_id", "entitlement_type", "entitlement_integration_specific_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UnassignEntitlement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UnassignEntitlement from a dict"""
        if obj is None:
            return None
