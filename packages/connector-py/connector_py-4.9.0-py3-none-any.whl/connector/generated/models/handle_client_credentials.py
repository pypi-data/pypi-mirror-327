...
class HandleClientCredentials(BaseModel):
    """
    Parameters for handling a client credentials request.
    """ # noqa: E501
    client_id: StrictStr = Field(description="The OAuth client ID provided by the third-party service, used to identify the application.")
    client_secret: StrictStr = Field(description="The OAuth client secret associated with the client ID, used to authenticate the application.")
    scopes: List[StrictStr] = Field(description="An array of strings representing the OAuth scopes to request, defining the access level.")
    __properties: ClassVar[List[str]] = ["client_id", "client_secret", "scopes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HandleClientCredentials from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HandleClientCredentials from a dict"""
        if obj is None:
            return None
