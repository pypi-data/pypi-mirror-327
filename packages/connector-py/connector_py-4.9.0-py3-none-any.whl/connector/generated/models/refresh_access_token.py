...
class RefreshAccessToken(BaseModel):
    ...
    refresh_token: StrictStr = Field(description="The token used to obtain a new access token, extending the session.")
    state: Optional[StrictStr] = Field(default=None, description="(Optional) A state parameter for security validation.")
    __properties: ClassVar[List[str]] = ["client_id", "client_secret", "refresh_token", "state"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RefreshAccessToken from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RefreshAccessToken from a dict"""
        if obj is None:
            return None
