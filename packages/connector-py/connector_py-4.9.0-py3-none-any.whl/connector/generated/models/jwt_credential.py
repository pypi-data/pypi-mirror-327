...
from connector.generated.models.jwt_claims import JWTClaims
from connector.generated.models.jwt_headers import JWTHeaders
from typing import Optional, Set
from typing_extensions import Self

class JWTCredential(BaseModel):
    """
    JWT credential model.
    """ # noqa: E501
    headers: JWTHeaders = Field(description="The JWT headers.")
    claims: JWTClaims = Field(description="The JWT claims.")
    secret: StrictStr = Field(description="The JWT secret.")
    __properties: ClassVar[List[str]] = ["headers", "claims", "secret"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JWTCredential from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JWTCredential from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "headers": JWTHeaders.from_dict(obj["headers"]) if obj.get("headers") is not None else None,
            "claims": JWTClaims.from_dict(obj["claims"]) if obj.get("claims") is not None else None,
