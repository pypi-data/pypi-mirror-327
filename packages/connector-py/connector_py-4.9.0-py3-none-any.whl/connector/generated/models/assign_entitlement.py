...
class AssignEntitlement(BaseModel):
    """
    Request payload for assigning an entitlement
    """ # noqa: E501
    account_integration_specific_id: StrictStr = Field(description="The unique identifier for the account in the third-party system")
    resource_integration_specific_id: StrictStr = Field(description="The unique identifier for the resource in the third-party system that the entitlement will be assigned to")
    resource_type: StrictStr = Field(description="The type of resource being assigned the entitlement (e.g. \"user\", \"team\", \"project\")")
    entitlement_type: StrictStr = Field(description="The type of entitlement being assigned (e.g. \"license\", \"permission\", \"quota\")")
    entitlement_integration_specific_id: StrictStr = Field(description="The unique identifier for the specific entitlement in the third-party system")
    __properties: ClassVar[List[str]] = ["account_integration_specific_id", "resource_integration_specific_id", "resource_type", "entitlement_type", "entitlement_integration_specific_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssignEntitlement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssignEntitlement from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "entitlement_integration_specific_id": obj.get("entitlement_integration_specific_id")
        })
        return _obj
