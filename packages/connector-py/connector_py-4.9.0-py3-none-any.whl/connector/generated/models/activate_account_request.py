...
from connector.generated.models.activate_account import ActivateAccount
...
class ActivateAccountRequest(BaseModel):
    ...
    request: ActivateAccount = Field(description="The main request payload.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": ActivateAccount.from_dict(obj["request"]) if obj.get("request") is not None else None,
