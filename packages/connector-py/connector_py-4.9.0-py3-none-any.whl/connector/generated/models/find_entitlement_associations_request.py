...
from connector.generated.models.find_entitlement_associations import FindEntitlementAssociations
from connector.generated.models.page import Page
from typing import Optional, Set
from typing_extensions import Self

class FindEntitlementAssociationsRequest(BaseModel):
    """
    Authenticated request.
    """ # noqa: E501
    auth: Optional[AuthCredential] = None
    credentials: Optional[List[AuthCredential]] = None
    request: FindEntitlementAssociations = Field(description="The main request payload.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FindEntitlementAssociationsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FindEntitlementAssociationsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "request": FindEntitlementAssociations.from_dict(obj["request"]) if obj.get("request") is not None else None,
