...
class FindEntitlementAssociations(BaseModel):
    """
    Request parameters for finding entitlement associations. Currently accepts empty input.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FindEntitlementAssociations from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FindEntitlementAssociations from a dict"""
        if obj is None:
            return None
