...
from connector.generated.models.list_entitlements import ListEntitlements
...
class ListEntitlementsRequest(BaseModel):
    ...
    request: ListEntitlements = Field(description="The main request payload.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListEntitlementsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListEntitlementsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "request": ListEntitlements.from_dict(obj["request"]) if obj.get("request") is not None else None,
