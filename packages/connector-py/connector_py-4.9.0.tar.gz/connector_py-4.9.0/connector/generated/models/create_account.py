...
class CreateAccount(BaseModel):
    ...
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="The email address for the new account")
    username: Optional[StrictStr] = Field(default=None, description="The username for the new account")
    given_name: Optional[StrictStr] = Field(default=None, description="The user's first/given name")
    family_name: Optional[StrictStr] = Field(default=None, description="The user's last/family name")
    user_status: Optional[StrictStr] = Field(default=None, description="Initial status for the account (e.g. \"active\", \"pending\")")
    extra_data: Optional[Dict[str, Any]] = Field(default=None, description="Additional connector-specific data needed for account creation")
    entitlements: List[CreateAccountEntitlement] = Field(description="List of _required_ entitlements that must be set when an account is created. This list is all entitlement types with a min > 0")
    __properties: ClassVar[List[str]] = ["email", "username", "given_name", "family_name", "user_status", "extra_data", "entitlements"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entitlements": [CreateAccountEntitlement.from_dict(_item) for _item in obj["entitlements"]] if obj.get("entitlements") is not None else None
        })
        return _obj
