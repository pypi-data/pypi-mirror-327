...
class FoundEntitlementData(BaseModel):
    ...
    extra_data: Optional[Dict[str, Any]] = Field(default=None, description="Additional data specific to the entitlement that doesn't fit into the standard fields.")
    integration_specific_id: StrictStr = Field(description="The unique ID within this application of an entitlement.  May only be unique within the tenant and the entitlement type.")
    integration_specific_resource_id: StrictStr = Field(description="The unique ID within this application of the resource this entitlement is for.  See `FoundResourceData.integration_specific_resource_id`")
    is_assignable: Optional[StrictBool] = Field(default=None, description="Indicates whether this entitlement can be assigned to users.")
    label: StrictStr = Field(description="A human-readable label for the entitlement.")
    __properties: ClassVar[List[str]] = ["entitlement_type", "extra_data", "integration_specific_id", "integration_specific_resource_id", "is_assignable", "label"]
