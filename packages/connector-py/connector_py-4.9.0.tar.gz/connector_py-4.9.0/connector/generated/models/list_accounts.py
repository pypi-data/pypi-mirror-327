...
class ListAccounts(BaseModel):
    ...
    """ # noqa: E501
    custom_attributes: Optional[List[StrictStr]] = Field(default=None, description="Optional array of custom attribute names to include in the account data. Each string in this array represents a specific custom attribute to retrieve.")
    __properties: ClassVar[List[str]] = ["custom_attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListAccounts from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListAccounts from a dict"""
        if obj is None:
            return None
