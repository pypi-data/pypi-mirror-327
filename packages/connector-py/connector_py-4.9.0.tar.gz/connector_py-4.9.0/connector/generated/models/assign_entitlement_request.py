...
from connector.generated.models.assign_entitlement import AssignEntitlement
...
class AssignEntitlementRequest(BaseModel):
    ...
    request: AssignEntitlement = Field(description="The main request payload.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssignEntitlementRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssignEntitlementRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "request": AssignEntitlement.from_dict(obj["request"]) if obj.get("request") is not None else None,
