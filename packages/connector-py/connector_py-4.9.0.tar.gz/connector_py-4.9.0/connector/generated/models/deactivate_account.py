...
class DeactivateAccount(BaseModel):
    """
    Request parameters for deactivating an account
    """ # noqa: E501
    account_id: StrictStr = Field(description="The unique identifier of the account to deactivate in the integration system")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeactivateAccount from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeactivateAccount from a dict"""
        if obj is None:
            return None
