...
from connector.generated.models.list_accounts import ListAccounts
...
class ListAccountsRequest(BaseModel):
    ...
    request: ListAccounts = Field(description="The main request payload.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListAccountsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListAccountsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "request": ListAccounts.from_dict(obj["request"]) if obj.get("request") is not None else None,
