...
class DeleteAccount(BaseModel):
    """
    Request parameters for deleting an account
    """ # noqa: E501
    account_id: StrictStr = Field(description="The unique identifier of the account to delete in the integration system")
