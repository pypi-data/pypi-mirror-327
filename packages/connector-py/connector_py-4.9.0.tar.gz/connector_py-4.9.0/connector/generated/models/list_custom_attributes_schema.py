...
class ListCustomAttributesSchema(BaseModel):
    """
    Request parameters for listing custom attribute schemas.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListCustomAttributesSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListCustomAttributesSchema from a dict"""
        if obj is None:
            return None
