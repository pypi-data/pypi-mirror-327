...
class FoundResourceData(BaseModel):
    ...
    """ # noqa: E501
    integration_specific_id: StrictStr = Field(description="The unique ID within this application of a resource.  May only be unique within the tenant and the resource type.  There will always be a global \"account\" (i.e. tenant) resource for things like tenant-wide roles.")
    ...
    extra_data: Optional[Dict[str, StrictStr]] = Field(default=None, description="Additional data specific to the resource that doesn't fit into the standard fields.")
    __properties: ClassVar[List[str]] = ["integration_specific_id", "label", "resource_type", "extra_data"]
