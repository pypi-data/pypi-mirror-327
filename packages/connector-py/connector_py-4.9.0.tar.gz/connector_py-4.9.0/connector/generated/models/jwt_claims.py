...
class JWTClaims(BaseModel):
    """
    JWT payload model representing the claims in the JWT.
    """ # noqa: E501
    iss: Optional[StrictStr] = Field(default=None, description="The issuer of the JWT.")
    sub: Optional[StrictStr] = Field(default=None, description="The subject of the JWT.")
    aud: Optional[StrictStr] = Field(default=None, description="The audience of the JWT.")
    exp: Optional[StrictInt] = Field(default=None, description="The expiration time of the JWT in seconds since the Unix epoch.")
    nbf: Optional[StrictInt] = Field(default=None, description="The not before time of the JWT in seconds since the Unix epoch.")
    iat: Optional[StrictInt] = Field(default=None, description="The issue time of the JWT in seconds since the Unix epoch.")
    jti: Optional[StrictStr] = Field(default=None, description="The JWT ID.")
    act: Optional[StrictStr] = Field(default=None, description="The Actor of the JWT.")
    scope: Optional[List[StrictStr]] = Field(default=None, description="Scopes granted to the JWT.")
    client_id: Optional[StrictStr] = Field(default=None, description="The client ID of the JWT.")
    may_act: Optional[StrictStr] = Field(default=None, description="The may_act of the JWT.")
    __properties: ClassVar[List[str]] = ["iss", "sub", "aud", "exp", "nbf", "iat", "jti", "act", "scope", "client_id", "may_act"]
