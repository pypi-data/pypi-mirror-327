...
class GetLastActivity(BaseModel):
    """
    Request parameters for retrieving last activity data
    """ # noqa: E501
    account_ids: List[StrictStr] = Field(description="List of account identifiers to fetch activity data for")
    __properties: ClassVar[List[str]] = ["account_ids"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetLastActivity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetLastActivity from a dict"""
        if obj is None:
            return None
