...
class SlackService:
    def __init__(self, credentials: dict):
        try:
            # Just get the token directly from the dictionary
            self.slack_bot_token = credentials['slack_bot_token'] or credentials.get('slack_bot_token')  # Using direct dictionary access
