...
from src.gluonts.mx.model.deepstate import DeepStateEstimator
from src.gluonts.mx.trainer import Trainer
from src.gluonts.testutil.dummy_datasets import make_dummy_datasets_with_features

common_estimator_hps = dict(
    freq="D",
    prediction_length=3,
    trainer=Trainer(epochs=1, num_batches_per_epoch=1, hybridize=True),
    past_length=10,
    add_trend=True,
)
