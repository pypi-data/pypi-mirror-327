...
from src.gluonts.model import Predictor
...
def doctest(doctest_namespace):
    ...
    doctest_namespace["gluonts"] = src.gluonts
...
def dsinfo(request):
    from src.gluonts import time_feature
    from src.gluonts.dataset.artificial import constant_dataset, default_synthetic
