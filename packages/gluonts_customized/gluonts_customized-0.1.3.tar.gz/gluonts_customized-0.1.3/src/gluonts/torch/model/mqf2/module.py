...
from src.gluonts.torch.model.deepar.module import DeepARModel
...
class MQF2MultiHorizonModel(DeepARModel):
    ...
    def __init__(
        ...
        distr_output: Optional[MQF2DistributionOutput] = None,
        ...
        This class is based on src.gluonts.torch.model.deepar.module.DeepARModel
