...
from src.gluonts.exceptions import GluonTSDataError
from src.gluonts.gluonts_tqdm import tqdm
from src.gluonts.mx.context import get_mxnet_context
from src.gluonts.mx.trainer.callback import Callback, CallbackList
from src.gluonts.mx.util import HybridContext
...
class Trainer:
    ...
    callbacks
        A list of `src.gluonts.mx.trainer.callback.Callback` to control the
        training.
