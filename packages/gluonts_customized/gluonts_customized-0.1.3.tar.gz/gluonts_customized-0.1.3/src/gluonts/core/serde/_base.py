...
from src.gluonts.pydantic import BaseModel
...
bad_type_msg = textwrap.dedent(
    ...
    `validate` functions at
        ...
        http://gluon-ts.mxnet.io/api/gluonts/src.gluonts.html
...
def encode(v: Any) -> Any:
    ...
    {'__kind__': <Kind.Instance: 'instance'>,
     'class': 'src.gluonts.core.serde._base.ComplexNumber',
     'kwargs': {'x': 4.0, 'y': 2.0}}

    Classes with a :func:`~src.gluonts.core.component.validated` initializer (as
