...
import requests
from src.gluonts.dataset.common import DataEntry
from src.gluonts.dataset.jsonl import encode_json
from src.gluonts.dataset.repository.datasets import materialize_dataset
from src.gluonts.model.predictor import Predictor
from src.gluonts.shell.env import ServeEnv, TrainEnv
from src.gluonts.shell.sagemaker import ServePaths, TrainPaths
from src.gluonts.shell.sagemaker.params import encode_sagemaker_parameters
from src.gluonts.shell.serve import Settings, make_flask_app
...
def temporary_train_env(
    ...
    Returns
    -------
    ContextManager[src.gluonts.shell.env.TrainEnv]
...
def temporary_serve_env(predictor: Predictor) -> ContextManager[ServeEnv]:
    ...
    Returns
    -------
    ContextManager[src.gluonts.shell.env.ServeEnv]
