...
from src.gluonts.dataset.common import MetaData
from src.gluonts.dataset.repository._tsf_datasets import Dataset as MonashDataset
from src.gluonts.dataset.repository._tsf_datasets import (
    save_datasets,
    save_metadata,
)
from src.gluonts.dataset.repository._tsf_reader import TSFReader
...
class GluonTsDatasetConfig(DatasetConfig):  # pylint: disable=abstract-method
    """
    A dataset configuration for datasets obtained directly via src.gluonts.
    """
