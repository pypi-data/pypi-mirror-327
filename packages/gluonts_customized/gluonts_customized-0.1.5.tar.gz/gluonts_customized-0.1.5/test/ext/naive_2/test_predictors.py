...
from gluonts_customized.ext.naive_2 import Naive2Predictor
...
from gluonts_customized.pydantic import PositiveInt
from gluonts_customized.time_feature import get_seasonality
