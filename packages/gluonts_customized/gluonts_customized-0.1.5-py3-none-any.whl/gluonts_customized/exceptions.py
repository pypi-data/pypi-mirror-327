...
from gluonts_customized.pydantic import ValidationError, display_errors
...
class GluonTSHyperparametersError(GluonTSException, ValueError):
    ...
    the validation of a :func:`~gluonts_customized.core.component.validated` initializer
    fails.
    """
