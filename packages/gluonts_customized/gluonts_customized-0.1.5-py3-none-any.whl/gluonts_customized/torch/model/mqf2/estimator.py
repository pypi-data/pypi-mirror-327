...
from gluonts_customized.torch.model.deepar.estimator import DeepAREstimator
...
class MQF2MultiHorizonEstimator(DeepAREstimator):
    ...
    This class is based on gluonts_customized.torch.model.deepar.estimator.DeepAREstimator
