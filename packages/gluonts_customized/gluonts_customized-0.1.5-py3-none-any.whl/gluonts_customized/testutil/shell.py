...
from gluonts_customized.dataset.jsonl import encode_json
from gluonts_customized.dataset.repository.datasets import materialize_dataset
from gluonts_customized.model.predictor import Predictor
from gluonts_customized.shell.env import ServeEnv, TrainEnv
from gluonts_customized.shell.sagemaker import ServePaths, TrainPaths
from gluonts_customized.shell.sagemaker.params import encode_sagemaker_parameters
from gluonts_customized.shell.serve import Settings, make_flask_app
...
def temporary_train_env(
    ...
    Returns
    -------
    ContextManager[gluonts_customized.shell.env.TrainEnv]
...
def temporary_serve_env(predictor: Predictor) -> ContextManager[ServeEnv]:
    ...
    Returns
    -------
    ContextManager[gluonts_customized.shell.env.ServeEnv]
