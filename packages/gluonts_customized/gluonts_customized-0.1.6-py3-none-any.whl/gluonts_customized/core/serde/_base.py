...
from gluonts_customized.pydantic import BaseModel
...
bad_type_msg = textwrap.dedent(
    ...
    `validate` functions at
        ...
        http://gluon-ts.mxnet.io/api/gluonts/gluonts_customized.html
...
def encode(v: Any) -> Any:
    ...
    {'__kind__': <Kind.Instance: 'instance'>,
     'class': 'gluonts_customized.core.serde._base.ComplexNumber',
     'kwargs': {'x': 4.0, 'y': 2.0}}

    Classes with a :func:`~gluonts_customized.core.component.validated` initializer (as
