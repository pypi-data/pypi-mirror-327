...
def aggregate_precision_recall_curve(
    ...
    See `gluonts_customized.nursery.anomaly_detection.supervised_metrics.filters` for
    example filters.
    ...
    partial_filter: Callable
        ...
        threshold.
        See `gluonts_customized.nursery.anomaly_detection.supervised_metrics.filters` for example filters.
