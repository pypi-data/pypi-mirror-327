...
from gluonts_customized.dataset.common import MetaData
from gluonts_customized.dataset.repository._tsf_datasets import Dataset as MonashDataset
from gluonts_customized.dataset.repository._tsf_datasets import (
    save_datasets,
    save_metadata,
)
from gluonts_customized.dataset.repository._tsf_reader import TSFReader
...
class GluonTsDatasetConfig(DatasetConfig):  # pylint: disable=abstract-method
    """
    A dataset configuration for datasets obtained directly via gluonts_customized.
    """
