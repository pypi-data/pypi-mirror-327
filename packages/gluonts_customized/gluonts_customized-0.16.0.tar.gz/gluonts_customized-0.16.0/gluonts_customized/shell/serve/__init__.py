...
from gluonts_customized.shell.env import ServeEnv
from gluonts_customized.pydantic import BaseSettings
...
class Settings(BaseSettings):
    ...
    gluonts_batch_fallback_predictor: str = (
        "gluonts_customized.model.trivial.mean.MeanPredictor"
    )
