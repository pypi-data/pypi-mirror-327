...
"""
gluonts_customized.core.settings
~~~~~~~~~~~~~~~~~~~~~
...
`gluonts_customized.env` is a `Settings`.

Example::

    from gluonts_customized.core.settings import Settings
...
from gluonts_customized.pydantic import pydantic, deep_update
