...
from gluonts_customized.model.forecast_generator import DistributionForecastGenerator
...
class SimpleFeedForwardEstimator(GluonEstimator):
    ...
    # For a more complex transformation example, see the `gluonts_customized.model.deepar`
