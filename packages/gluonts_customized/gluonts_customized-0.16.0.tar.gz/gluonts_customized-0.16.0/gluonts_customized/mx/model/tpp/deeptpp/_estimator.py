...
from gluonts_customized.mx.model.tpp import PointProcessGluonPredictor
...
class DeepTPPEstimator(GluonEstimator):
    ...
    inter-arrival times - see :code:`gluonts_customized.model.tpp.distribution`.
    ...
    time_distr_output
        ...
        times. See :code:`gluonts_customized.model.tpp.distribution` for possible choices.
    embedding_dim
        The dimension of vector embeddings for marks (used as input to the
        GRU).
    trainer
        :code:`gluonts_customized.mx.trainer.Trainer` object which will be used to train
