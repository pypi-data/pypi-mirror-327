...
from gluonts_customized.dataset import DataEntry
from gluonts_customized.dataset.split import TestData
from gluonts_customized.ev.ts_stats import seasonal_error
from gluonts_customized.itertools import batcher, prod
from gluonts_customized.model import Forecast, Predictor
...
class BatchForecast:
    ...
    returned by ``__getitem__``, for compatibility with ``gluonts_customized.ev``.
    """
