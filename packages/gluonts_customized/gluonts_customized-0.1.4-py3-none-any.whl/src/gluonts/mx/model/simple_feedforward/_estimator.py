...
from src.gluonts.model.forecast_generator import DistributionForecastGenerator
...
from src.gluonts.transform.feature import (
...
class SimpleFeedForwardEstimator(GluonEstimator):
    ...
    # For a more complex transformation example, see the `src.gluonts.model.deepar`
