...
from src.gluonts.mx.model.tpp import PointProcessGluonPredictor
from src.gluonts.mx.model.tpp.distribution import (
...
class DeepTPPEstimator(GluonEstimator):
    ...
    inter-arrival times - see :code:`src.gluonts.model.tpp.distribution`.
    ...
    time_distr_output
        ...
        times. See :code:`src.gluonts.model.tpp.distribution` for possible choices.
    embedding_dim
        The dimension of vector embeddings for marks (used as input to the
        GRU).
    trainer
        :code:`src.gluonts.mx.trainer.Trainer` object which will be used to train
