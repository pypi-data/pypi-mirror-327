...
from gluonts_customized.exceptions import GluonTSDataError
from gluonts_customized.gluonts_tqdm import tqdm
from gluonts_customized.mx.context import get_mxnet_context
from gluonts_customized.mx.trainer.callback import Callback, CallbackList
from gluonts_customized.mx.util import HybridContext
...
class Trainer:
    ...
    callbacks
        A list of `gluonts_customized.mx.trainer.callback.Callback` to control the
        training.
