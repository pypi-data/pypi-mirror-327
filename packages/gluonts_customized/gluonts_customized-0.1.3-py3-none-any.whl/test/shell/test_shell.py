...
from src.gluonts.model.trivial.mean import MeanPredictor
from src.gluonts.shell.env import ServeEnv, TrainEnv
from src.gluonts.shell.train import run_train_and_test

try:
    from src.gluonts.shell.serve import Settings
    from src.gluonts.testutil import shell as testutil
except ImportError:
