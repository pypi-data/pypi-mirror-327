...
from src.gluonts.dataset import DataEntry
from src.gluonts.dataset.split import TestData
from src.gluonts.ev.ts_stats import seasonal_error
from src.gluonts.itertools import batcher, prod
from src.gluonts.model import Forecast, Predictor
...
class BatchForecast:
    ...
    returned by ``__getitem__``, for compatibility with ``src.gluonts.ev``.
    """
