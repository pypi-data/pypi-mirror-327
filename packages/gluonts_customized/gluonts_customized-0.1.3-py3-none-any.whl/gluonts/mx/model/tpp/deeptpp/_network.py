...
from src.gluonts.mx.model.tpp import distribution
from src.gluonts.mx.model.tpp.distribution.base import TPPDistributionOutput
from src.gluonts.mx import Tensor
from src.gluonts.mx.distribution import CategoricalOutput
...
class DeepTPPNetworkBase(mx.gluon.HybridBlock):
    ...
    time_distr_output
        ...
        distributions can be found in src.gluonts.model.tpp.distribution.
    embedding_dim
