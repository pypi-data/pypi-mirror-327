...
`src.gluonts.env` is a `Settings`.

Example::

    from src.gluonts.core.settings import Settings
...
from src.gluonts.pydantic import pydantic, deep_update
