...
from src.gluonts.evaluation import Evaluator, backtest
from src.gluonts.model.estimator import Estimator, IncrementallyTrainable
from src.gluonts.model.forecast import Quantile
from src.gluonts.model.predictor import Predictor
from src.gluonts.itertools import maybe_len
from src.gluonts.transform import FilterTransformation
...
def log_version(forecaster_type):
    ...
    logger.info(f"Using gluonts v{src.gluonts.__version__}")
