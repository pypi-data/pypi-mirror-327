            ...
            for mdb in multi_twix[-1]['mdb']:
                ...
                if mdb.is_flag_set('NOISEADJSCAN') or mdb.is_flag_set('PHASCOR'):
                    ...
                    if dataset.rawData is None:
                        dataset.discardPre = mdb.mdh.CutOff.Pre; # Fix doubling in sequence - weird; I think this is because of the sequence parameter "RO Oversample" in the rseqlim
                        if(dataset.trajectoryReadoutLength != -1):
                            ...
                            dataset.discardPost = mdb.data.shape[1]-mdb.mdh.CutOff.Post;
