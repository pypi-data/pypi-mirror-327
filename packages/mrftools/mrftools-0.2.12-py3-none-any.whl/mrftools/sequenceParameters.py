...
class SequenceParameters:
    ...
    def __init__(self, name:str, modules=[], trajectory:TrajectoryParameters=None, version="dev", initializeWithDummyScan=False, sequenceUnits=SequenceUnits(Units.SECONDS,Units.DEGREES)):
        """
        ...
        self.initializeWithDummyScan = initializeWithDummyScan
    ...
    def __dict__(self):
        ...
        sequenceDict  = {
            ...
            "initializeWithDummyScan": self.initializeWithDummyScan,
    ...
    def Simulate(self, dictionaryEntries, numSpins, device=None):
        ...
        initializeWithDummyScan : bool
            For use with 3D acquisitions - run simulation twice, with Mz retained between first and second iteration.
            Dictionary is populated with second iteration results.
        ...
        if self.initializeWithDummyScan:
            prior = Mz0[-1,:,:]
            Time = torch.zeros([1]); 
            Mx0 = torch.zeros([1,numSpins, len(dictionaryEntries)]); ReadoutMx0 = torch.zeros([1,numSpins, len(dictionaryEntries)]); 
            My0 = torch.zeros([1,numSpins, len(dictionaryEntries)]); ReadoutMy0 = torch.zeros([1,numSpins, len(dictionaryEntries)]); 
            Mz0 = torch.zeros([1,numSpins, len(dictionaryEntries)]); ReadoutMz0 = torch.ones([1,numSpins, len(dictionaryEntries)])
            Mz0[-1,:,:] = prior
    ...
    def FromJson(inputJson):
        ...
        initializeWithDummyScan = sequenceJson.get("initializeWithDummyScan")
        ...
        return SequenceParameters(sequenceName,sequenceModules, sequenceTrajectory, sequenceVersion, initializeWithDummyScan, sequenceUnits)
