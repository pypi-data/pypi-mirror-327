...
class PlotDatasetPopulationDistributionAge:
    """
    Class to generate and save plots for dataset population distribution based on age.
    """
    def __init__(self, data=None, cohort_id=None):
        """
        Initializes the PlotDatasetPopulationDistributionAge with data and optional cohort identifier.

        :param data: List of dictionaries containing 'Age' information, defaults to None.
    ...
    def _validate_data(self, json_file):
        ...
        :param json_file: Path to the JSON file containing age data.
        :type json_file: str
    ...
    def calculate(self):
        """
        Calculates age distribution metrics such as mean and median age.

        :return: Dictionary containing ages, mean age, and median age.
        :rtype: dict
    ...
    def plot_age(self, json_file, suffix=''):
        """
        Generates a bar plot for age distribution based on the provided JSON data.
        ...
        :return: Matplotlib Figure object with the age distribution plot.
        :rtype: Figure
...
@plot_manager.register("semantic_segmentation.dataset_population_distribution_age")
def plot_dataset_population_distribution_age(
    results: dict,
    save_plot: bool,
    file_name: str = "dataset_population_distribution_age.png",
    ...
    :type save_plot: bool
    :param file_name: Name of the file to save the plot as, defaults to "dataset_population_distribution_age.png".
    :type file_name: str
    :param cohort_id: Optional identifier for the cohort, defaults to None.
    :type cohort_id: Optional[int], optional
    :param suffix: Optional suffix to add to the plot title, defaults to ''.
