...
class ConcentrationResponse(UniversalBaseModel):
    ...
    time_series_metrics: typing.Optional[typing.List[ConcentrationTimeseriesDetail]] = (
    ...
    endpoint_top_users: typing.Optional[
        typing.List[ConcentrationEndpointTopUsersDetail]
    ] = pydantic.Field(default=None)
    """
    Detail for the top users at the endpoint. Up to the top 100 users are show.
    """

    endpoint_cdf: typing.Optional[typing.List[ConcentrationEndpointCdfDetail]] = (
        pydantic.Field(default=None)
    )
    """
