...
class UserWithPermissionsResponse(UniversalBaseModel):
    ...
    permissions_by_group: typing.Optional[typing.Dict[str, typing.Optional[typing.List[PermissionModel]]]] = None
