...
class ConcentrationTimeseriesDetail(UniversalBaseModel):
    ...
    p_25: typing_extensions.Annotated[
        typing.Optional[float], FieldMetadata(alias="p25")
    ...
    p_75: typing_extensions.Annotated[
        typing.Optional[float], FieldMetadata(alias="p75")
    ] = pydantic.Field(default=None)
    """
