...
help_texts = {
    ...
    'lino_xl.lib.ibanity.OnboardingStates' : _("""A choicelist with values for the Supplier.onboarding_state."""),
    'lino_xl.lib.ibanity.Supplier' : _("""Django model used to represent an Ibanity supplier"""),
    'lino_xl.lib.ibanity.CustomerStates' : _("""A choicelist with three values:"""),
    'lino_xl.lib.ibanity.SuppliersListChecker' : _("""Checks whether all suppliers that were registered by this Ibanity client have a Supplier row on this Lino site."""),
    'lino_xl.lib.ibanity.SupplierChecker' : _("""Synchronizes this Supplier row with the data registered in the Ibanity API."""),
