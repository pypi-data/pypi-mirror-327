...
class SoilCollection(DataModel):
    ...
    def from_csv(obj, filename: str) -> "SoilCollection":
        ...
        by lines with the parameters 'code, color, yd, ys, c, friction angle, dilatancy angle'
    ...
    def to_csv(self, filepath: str, filename: str) -> None:
        ...
        f.write("code,color,yd,ys,c,phi\n")
        for soil in self.soils:
            f.write(
                f"{soil.code},{soil.color},{soil.yd},{soil.ys},{soil.c},{soil.phi}\n"
            )
        f.close()
