...
# @copy_files_to_pyodide(file_list=[(wheel_path, wheel_stem)],install_wheels=True)
# @run_in_pyodide(packages=['micropip'])
# async def test_structured_report_to_html(selenium, input_data):
#     # import micropip
#     # from js import window
#     # origin = window.location.origin
#     # await micropip.install(f"{origin}/{package_wheel}")
...
# @copy_files_to_pyodide(file_list=[(wheel_path, wheel_stem)],install_wheels=True)
# @run_in_pyodide(packages=['micropip'])
# async def test_read_key_object_selection_sr(selenium, input_data):
#     # import micropip
#     # from js import window
#     # origin = window.location.origin
#     # await micropip.install(f"{origin}/{package_wheel}")
