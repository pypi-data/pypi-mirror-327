...
setup(
    name="gif-converter",  # Package name (how it's imported)
    version="0.1.1",
    ...
    url="https://github.com/brxtnmann/gif_converter",
    packages=find_packages(), # This will find the gif_converter package
    install_requires=[
        "moviepy",
        "dearpygui",
        "Pillow",
        "pyFfmpeg-installer",  # ffmpeg_installer is now a *required* dependency
    ],
    entry_points={
        "console_scripts": [
