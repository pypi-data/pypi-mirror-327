...
def run_from_terminal():
    ...
    parser.add_argument('--small-delta', type=float, default=15, help='Gradient duration in miliseconds')
    parser.add_argument('--big-delta', type=float, default=45, help='Time to scan (time interval) in milisecond')
    parser.add_argument('--gmax', type=float, default=7.9, help='Gradient maximum amplitude in G/cm')
    parser.add_argument('--gamma-val', type=int, default=4257, help='Gyromagnetic ratio')
    parser.add_argument('--num-processes-pred', type=int, default=1,
                        help='Number of processes to run in parallel in prediction step')
    parser.add_argument('--num-threads-pred', type=int, default=1,
                        help='Number of threads to run in parallel in prediction step')
    parser.add_argument('--num-processes-axsi', type=int, default=1,
                        help='Number of processes to run in parallel in AxSI step')
    parser.add_argument('--num-threads-axsi', type=int, default=1,
                        help='Number of threads to run in parallel in AxSI step')
