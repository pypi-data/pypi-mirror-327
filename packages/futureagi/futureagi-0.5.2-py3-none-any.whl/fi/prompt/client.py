...
class PromptClient(APIKeyAuth):
    ...
    def create(self) -> "PromptClient":
        ...
        messages = [message.model_dump() for message in self.template.messages]
        json = {
            "name": self.template.name,
            "prompt_config": {
                "messages": messages,
                "configuration": self.template.model_configuration.model_dump(),
            },
        ...
        response = self.request(
            config=RequestConfig(
                ...
                json={
                    ...
                    "evaluation_configs": self.template.evaluation_configs,
                    "name": self.template.name,
                    "is_run": True,
                },
            ),
