...
from fi.integrations.otel.frameworks.bedrock.utils import _EventStream, _use_span
from fi.integrations.otel.frameworks.bedrock.utils.anthropic._messages import (
...
class _InvokeModelWithResponseStream(_WithTracer):
    ...
    def __call__(
        ...
        with self._tracer.start_as_current_span(
            ...
            print("streaming response body", response["body"])
