...
from fi.integrations.otel.frameworks.openai._request_attributes_extractor import (
    _RequestAttributesExtractor,
)
from fi.integrations.otel.frameworks.openai._response_accumulator import (
    _ChatCompletionAccumulator,
    _CompletionAccumulator,
)
from fi.integrations.otel.frameworks.openai._response_attributes_extractor import (
    _ResponseAttributesExtractor,
)
from fi.integrations.otel.frameworks.openai._span_io_handler import (
    add_io_to_span_attributes,
)
from fi.integrations.otel.frameworks.openai._stream import _ResponseAccumulator, _Stream
from fi.integrations.otel.frameworks.openai._utils import (
...
from fi.integrations.otel.instrumentation import get_attributes_from_context
    ...
    async def __call__(
        ...
        with self._start_as_current_span(
            ...
            try:
                ...
                print(f"Finalized response: {response}")
            except Exception:
                logger.exception(
