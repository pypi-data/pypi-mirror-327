...
def read_raw_data_file_4( filename, f, resin_data, file_data, data ):
    ...
    for r in resins:
        ...
        for f in filenames:
            ...
            if resin == 28:
                ...
                read_raw_data_file_4( data_directory + r + "/" + f, f, resin_data, file_data, data )
