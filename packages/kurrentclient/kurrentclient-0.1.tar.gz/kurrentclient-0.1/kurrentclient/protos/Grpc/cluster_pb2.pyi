...
class ViewChangeRequest(google.protobuf.message.Message):
    ...
    @property
    def server_id(self) -> kurrentclient.protos.Grpc.shared_pb2.UUID: ...
    @property
    def server_http(self) -> global___EndPoint: ...
    def __init__(
        self,
        *,
        server_id: kurrentclient.protos.Grpc.shared_pb2.UUID | None = ...,
...
class PrepareOkRequest(google.protobuf.message.Message):
    ...
    def server_http(self) -> global___EndPoint: ...
    @property
    def epoch_id(self) -> kurrentclient.protos.Grpc.shared_pb2.UUID: ...
    @property
    def epoch_leader_instance_id(self) -> kurrentclient.protos.Grpc.shared_pb2.UUID: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        epoch_number: builtins.int = ...,
        epoch_position: builtins.int = ...,
        epoch_id: kurrentclient.protos.Grpc.shared_pb2.UUID | None = ...,
        epoch_leader_instance_id: kurrentclient.protos.Grpc.shared_pb2.UUID | None = ...,
        last_commit_position: builtins.int = ...,
        writer_checkpoint: builtins.int = ...,
        chaser_checkpoint: builtins.int = ...,
        node_priority: builtins.int = ...,
...
class ProposalRequest(google.protobuf.message.Message):
    ...
    def server_http(self) -> global___EndPoint: ...
    @property
    def leader_id(self) -> kurrentclient.protos.Grpc.shared_pb2.UUID: ...
    @property
    ...
    def __init__(
        ...
        *,
        server_id: kurrentclient.protos.Grpc.shared_pb2.UUID | None = ...,
        server_http: global___EndPoint | None = ...,
        leader_id: kurrentclient.protos.Grpc.shared_pb2.UUID | None = ...,
...
class MemberInfo(google.protobuf.message.Message):
    ...
    @property
    def instance_id(self) -> kurrentclient.protos.Grpc.shared_pb2.UUID: ...
    @property
    ...
    def __init__(
        self,
        *,
        instance_id: kurrentclient.protos.Grpc.shared_pb2.UUID | None = ...,
        time_stamp: builtins.int = ...,
        state: global___MemberInfo.VNodeState.ValueType = ...,
        is_alive: builtins.bool = ...,
