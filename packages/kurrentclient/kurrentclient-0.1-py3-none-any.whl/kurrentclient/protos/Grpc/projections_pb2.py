...
# source: kurrentclient/protos/Grpc/projections.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'kurrentclient/protos/Grpc/projections.proto'
)
