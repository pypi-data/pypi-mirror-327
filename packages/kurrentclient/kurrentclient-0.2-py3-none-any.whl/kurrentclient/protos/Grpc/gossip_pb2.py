...
# source: kurrentclient/protos/Grpc/gossip.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'kurrentclient/protos/Grpc/gossip.proto'
)
