...
class CreateReq(google.protobuf.message.Message):
    ...
    class Options(google.protobuf.message.Message):
        ...
        query: builtins.str
        @property
        def one_time(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        @property
        ...
        def __init__(
            self,
            *,
            one_time: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
...
class UpdateReq(google.protobuf.message.Message):
    ...
    class Options(google.protobuf.message.Message):
        ...
        emit_enabled: builtins.bool
        @property
        def no_emit_options(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        def __init__(
            self,
            *,
            name: builtins.str = ...,
            query: builtins.str = ...,
            emit_enabled: builtins.bool = ...,
            no_emit_options: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
        ) -> None: ...
...
class StatisticsReq(google.protobuf.message.Message):
    ...
    class Options(google.protobuf.message.Message):
        ...
        @property
        def transient(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        @property
        def continuous(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        @property
        def one_time(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        def __init__(
            self,
            *,
            ...
            transient: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
            continuous: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
            one_time: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
        ) -> None: ...
