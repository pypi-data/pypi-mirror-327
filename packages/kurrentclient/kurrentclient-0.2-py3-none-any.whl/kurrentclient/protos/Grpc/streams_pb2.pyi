...
import kurrentclient.protos.Grpc.shared_pb2
import kurrentclient.protos.Grpc.status_pb2
import sys
import typing
...
class ReadReq(google.protobuf.message.Message):
    ...
    class Options(google.protobuf.message.Message):
        ...
        class StreamOptions(google.protobuf.message.Message):
            ...
            @property
            def stream_identifier(self) -> kurrentclient.protos.Grpc.shared_pb2.StreamIdentifier: ...
            @property
            def start(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
            @property
            def end(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
            def __init__(
                self,
                *,
                stream_identifier: kurrentclient.protos.Grpc.shared_pb2.StreamIdentifier | None = ...,
                revision: builtins.int = ...,
                start: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
                end: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
            ) -> None: ...
        ...
        class FilterOptions(google.protobuf.message.Message):
            ...
            @property
            def count(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
            def __init__(
                self,
                *,
                ...
                max: builtins.int = ...,
                count: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
                checkpointIntervalMultiplier: builtins.int = ...,
            ) -> None: ...
        ...
        class UUIDOption(google.protobuf.message.Message):
            ...
            @property
            def structured(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
            @property
            def string(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
            def __init__(
                self,
                *,
                structured: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
                string: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
            ) -> None: ...
        ...
        @property
        def no_filter(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        @property
        ...
        def __init__(
            ...
            *,
            ...
            no_filter: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
...
class ReadResp(google.protobuf.message.Message):
    ...
    class ReadEvent(google.protobuf.message.Message):
        ...
        class RecordedEvent(google.protobuf.message.Message):
            ...
            data: builtins.bytes
            @property
            def id(self) -> kurrentclient.protos.Grpc.shared_pb2.UUID: ...
            @property
            def stream_identifier(self) -> kurrentclient.protos.Grpc.shared_pb2.StreamIdentifier: ...
            @property
            ...
            def __init__(
                self,
                *,
                id: kurrentclient.protos.Grpc.shared_pb2.UUID | None = ...,
                stream_identifier: kurrentclient.protos.Grpc.shared_pb2.StreamIdentifier | None = ...,
                stream_revision: builtins.int = ...,
                prepare_position: builtins.int = ...,
                commit_position: builtins.int = ...,
        ...
        @property
        def no_position(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        def __init__(
            self,
            *,
            ...
            commit_position: builtins.int = ...,
            no_position: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
        ) -> None: ...
    ...
    @property
    def last_all_stream_position(self) -> kurrentclient.protos.Grpc.shared_pb2.AllStreamPosition: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        first_stream_position: builtins.int = ...,
        last_stream_position: builtins.int = ...,
        last_all_stream_position: kurrentclient.protos.Grpc.shared_pb2.AllStreamPosition | None = ...,
...
class AppendReq(google.protobuf.message.Message):
    ...
    class Options(google.protobuf.message.Message):
        ...
        def stream_identifier(self) -> kurrentclient.protos.Grpc.shared_pb2.StreamIdentifier: ...
        @property
        def no_stream(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        @property
        def any(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        @property
        def stream_exists(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        def __init__(
            self,
            *,
            stream_identifier: kurrentclient.protos.Grpc.shared_pb2.StreamIdentifier | None = ...,
            revision: builtins.int = ...,
            no_stream: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
            any: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
            stream_exists: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
        ) -> None: ...
...
class AppendResp(google.protobuf.message.Message):
    ...
    class WrongExpectedVersion(google.protobuf.message.Message):
        ...
        @property
        def no_stream_20_6_0(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        @property
        def any_20_6_0(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        @property
        def stream_exists_20_6_0(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        @property
        def current_no_stream(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        @property
        def expected_any(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        @property
        def expected_stream_exists(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        @property
        def expected_no_stream(self) -> kurrentclient.protos.Grpc.shared_pb2.Empty: ...
        def __init__(
            self,
            *,
            current_revision_20_6_0: builtins.int = ...,
            no_stream_20_6_0: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
            expected_revision_20_6_0: builtins.int = ...,
            any_20_6_0: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
            stream_exists_20_6_0: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
            current_revision: builtins.int = ...,
            current_no_stream: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
            expected_revision: builtins.int = ...,
            expected_any: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
            expected_stream_exists: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
            expected_no_stream: kurrentclient.protos.Grpc.shared_pb2.Empty | None = ...,
        ) -> None: ...
...
class BatchAppendReq(google.protobuf.message.Message):
    ...
    @property
    def correlation_id(self) -> kurrentclient.protos.Grpc.shared_pb2.UUID: ...
    @property
    ...
    def __init__(
        self,
        *,
        correlation_id: kurrentclient.protos.Grpc.shared_pb2.UUID | None = ...,
...
class BatchAppendResp(google.protobuf.message.Message):
    ...
    class Success(google.protobuf.message.Message):
        ...
        def no_stream(self) -> google.protobuf.empty_pb2.Empty: ...
        @property
        def position(self) -> kurrentclient.protos.Grpc.shared_pb2.AllStreamPosition: ...
        @property
        ...
        def __init__(
            ...
            *,
            current_revision: builtins.int = ...,
            no_stream: google.protobuf.empty_pb2.Empty | None = ...,
            position: kurrentclient.protos.Grpc.shared_pb2.AllStreamPosition | None = ...,
    ...
    def correlation_id(self) -> kurrentclient.protos.Grpc.shared_pb2.UUID: ...
    @property
    def error(self) -> kurrentclient.protos.Grpc.status_pb2.Status: ...
    @property
    ...
    def __init__(
        ...
        *,
        correlation_id: kurrentclient.protos.Grpc.shared_pb2.UUID | None = ...,
        error: kurrentclient.protos.Grpc.status_pb2.Status | None = ...,
