...
class TrabalhadoreDTO(DTOBase):
    ...
    salariofixo: int = DTOField()
    salariovariavel: int = DTOField()
    ...
    numerohorasmensais: int = DTOField()
    ...
    saldofgts: int = DTOField()
    percentualadiantamento: int = DTOField()
    ...
    quantidademediahorassemanais: int = DTOField()
    ...
    instituicaointegradora: uuid.UUID = DTOField(
      ...
      max=36,
      validator=DTOFieldValidators().validate_uuid,)
    percentualdeducaobaseirrf: int = DTOField()
    percentualdeducaobaseinss: int = DTOField()
    aliquotaiss: int = DTOField()
    ...
    valorgratificacoesrescisao: int = DTOField()
    valorbancohorasrescisao: int = DTOField()
