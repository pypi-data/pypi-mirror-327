...
class EmpresaDTO(DTOBase):
    ...
    valorsubtetoexecutivo: int = DTOField()
    valorsubtetolegislativo: int = DTOField()
    valorsubtetojudiciario: int = DTOField()
    valorsubtetotodospoderes: int = DTOField()
    ...
    valorsubtetoentefederativo: int = DTOField()
