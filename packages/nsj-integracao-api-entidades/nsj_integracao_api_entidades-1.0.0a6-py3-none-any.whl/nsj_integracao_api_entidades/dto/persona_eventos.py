...
class EventoDTO(DTOBase):
    ...
    acumulahoraextra: bool = DTOField(
      not_null=True,)
    valorminimo: int = DTOField()
    valormaximo: int = DTOField()
    ...
    valorconteudolimitealerta: int = DTOField()
    valorconteudolimiteerro: int = DTOField()
