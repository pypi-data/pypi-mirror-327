...
class EmpresaEntity(EntityBase):
    ...
    valorsubtetoexecutivo: int = None
    valorsubtetolegislativo: int = None
    valorsubtetojudiciario: int = None
    valorsubtetotodospoderes: int = None
    ...
    valorsubtetoentefederativo: int = None
