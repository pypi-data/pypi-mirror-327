...
def extract_actions(
    ...
    """
    Extract actions between points by scanning backwards from 'point_idx - 1'
    until we hit another point or the beginning of the file.
    """
    ...
    # Collect actions from first to last
