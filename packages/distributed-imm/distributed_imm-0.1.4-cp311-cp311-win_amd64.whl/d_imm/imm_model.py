...
class DistributedIMM:
    def __init__(self, spark, k, max_leaves=None, verbose=0, n_jobs=None, mode=0, split_count=32, histogram_example_count=10000):
        """
        ...
        self.histogram_example_count = histogram_example_count
    ...
    def fit(self, x_data: DataFrame, kmeans_model=None):
        ...
        if self.verbose > 0:
            ...
            print(f"Time taken to build histogram: {int(minutes)} minutes and {seconds:.2f} seconds")
