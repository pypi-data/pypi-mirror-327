...
class ArnelifyServer:
  def __init__(self, libPath: str = "", opts: dict = {}):

    if not len(libPath):
      print("\n\nError: It's necessary to specify the dynamic library path as shown here:\n\nhttps://github.com/arnelify/arnelify-server-python/blob/main/tests/index.py\n\n")
      exit(1)
