...
class SecureShareCLI:
    def __init__(self):
        ...
        if not self.supabase_url or not self.supabase_key:
            ...
            print("Please ensure VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY are set in your environment.")
            sys.exit(1)
...
def main():
    parser = argparse.ArgumentParser(description='SecureShare CLI - Share code snippets securely')
