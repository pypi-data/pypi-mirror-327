...
def dataset_is_binned(
    ...
    try:
        ...
        if len(x) == len(bin_centers) or array_issubset(bin_centers, x):
            return True

        raise HistogramError("Invalid binning detected")
