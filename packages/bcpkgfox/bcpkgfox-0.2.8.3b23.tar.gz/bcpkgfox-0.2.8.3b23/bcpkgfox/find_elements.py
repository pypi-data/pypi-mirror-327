...
class Elements:
    def __init__(self, self_wb):
        from .get_driver import Webdriver as wb
        self.wb = self_wb
        self.driver = self.wb.driver

    def find_element_with_wait(self,
        by: str,
        value: str,
    ...
    def find_elements_with_wait(self,
        by: str,
        value: str,
        timeout: Optional[int] = 10,
        parent: Optional[WebElement] = None
    ...
    def wait_for_element_be_clickable(self,
        by: str,
        value: str,
        timeout: Optional[int] = 10,
        parent: Optional[WebElement] = None
