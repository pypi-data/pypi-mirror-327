...
# Python definition for <default namespace>

from .Live2D.Cubism.Core import CubismDrawable
from .Live2D.Cubism.Rendering import CubismRenderer

@typetree_defined
class __StaticArrayInitTypeSize_10454(MonoBehaviour):
	pass
@typetree_defined
class __StaticArrayInitTypeSize_9233(MonoBehaviour):
	pass
@typetree_defined
class __generic_c(MonoBehaviour):
	pass
@typetree_defined
class __generic_c__DisplayClass16_0(MonoBehaviour):
	pass
@typetree_defined
class __generic_c__DisplayClass43_0(MonoBehaviour):
	pass
@typetree_defined
class __generic_c__DisplayClass44_0(MonoBehaviour):
	pass
@typetree_defined
class _Module_(MonoBehaviour):
	pass
@typetree_defined
class _PrivateImplementationDetails_(MonoBehaviour):
	pass
@typetree_defined
class AllocationItem(MonoBehaviour):
	pass
@typetree_defined
class CombinedParameter(MonoBehaviour):
	HorizontalParameterId : str
	VerticalParameterId : str
@typetree_defined
class CubismDisplayInfoCombinedParameterInfo(MonoBehaviour):
	pass
@typetree_defined
class CubismTaskHandler(MonoBehaviour):
	pass
@typetree_defined
class DynamicDrawableDataHandler(MonoBehaviour):
	pass
@typetree_defined
class HitArea(MonoBehaviour):
	value__ : int
@typetree_defined
class HitDrawableInfomation(MonoBehaviour):
	drawable : PPtr[CubismDrawable]
	hitArea : int
@typetree_defined
class LayoutContext(MonoBehaviour):
	RenderTextureIndex : int
	Channel : int
	LayoutCount : int
	LayoutContextIndex : int
@typetree_defined
class LoadAssetAtPathHandler(MonoBehaviour):
	pass
@typetree_defined
class MasksMaskedsPair(MonoBehaviour):
	Masks : List[PPtr[CubismRenderer]]
	Maskeds : object # XXX: Fallback of List`1
@typetree_defined
class MasksMaskedsPairs(MonoBehaviour):
	pass
@typetree_defined
class MaterialPicker(MonoBehaviour):
	pass
@typetree_defined
class MonoScriptData(MonoBehaviour):
	FilePathsData : List[int]
	TypesData : List[int]
	TotalTypes : int
	TotalFiles : int
	IsEditorOnly : bool
@typetree_defined
class NormalizedParameterValueGetter(MonoBehaviour):
	pass
@typetree_defined
class Phase(MonoBehaviour):
	value__ : int
@typetree_defined
class PhysicsDictionaryItem(MonoBehaviour):
	Id : str
	Name : str
@typetree_defined
class ScaleGetter(MonoBehaviour):
	pass
@typetree_defined
class SegmentParser(MonoBehaviour):
	pass
@typetree_defined
class SerializableCombinedParameterIds(MonoBehaviour):
	Ids : List[str]
@typetree_defined
class SerializableCurve(MonoBehaviour):
	Target : str
	Id : str
	Segments : List[float]
	FadeInTime : float
	FadeOutTime : float
@typetree_defined
class SerializableVector2(MonoBehaviour):
	X : float
	Y : float
@typetree_defined
class SerializableEffectiveForces(MonoBehaviour):
	Gravity : SerializableVector2
	Wind : SerializableVector2
@typetree_defined
class SerializableExpression(MonoBehaviour):
	Name : str
	File : str
	FadeInTime : float
	FadeOutTime : float
@typetree_defined
class SerializableExpressionParameter(MonoBehaviour):
	Id : str
	Value : float
	Blend : str
@typetree_defined
class SerializableMotions(MonoBehaviour):
	GroupNames : List[str]
@typetree_defined
class SerializableFileReferences(MonoBehaviour):
	Moc : str
	Textures : List[str]
	Pose : str
	Expressions : List[SerializableExpression]
	Motions : SerializableMotions
	Physics : str
	UserData : str
	DisplayInfo : str
@typetree_defined
class SerializableGroup(MonoBehaviour):
	Target : str
	Name : str
	Ids : List[str]
@typetree_defined
class SerializableHitArea(MonoBehaviour):
	Name : str
	Id : str
@typetree_defined
class SerializableParameter(MonoBehaviour):
	Target : str
	Id : str
@typetree_defined
class SerializableInput(MonoBehaviour):
	Source : SerializableParameter
	Weight : float
	Type : str
	Reflect : bool
@typetree_defined
class SerializableMeta(MonoBehaviour):
	Duration : float
	Fps : float
	Loop : bool
	CurveCount : int
	...
	UserDataCount : int
	TotalUserDataSize : int
	FadeInTime : float
	FadeOutTime : float
@typetree_defined
class SerializableMotion(MonoBehaviour):
	File : str
	Sound : str
	FadeInTime : float
	FadeOutTime : float
@typetree_defined
class SerializableNormalizationValue(MonoBehaviour):
	Minimum : float
	Default : float
	Maximum : float
@typetree_defined
class SerializableNormalization(MonoBehaviour):
	Position : SerializableNormalizationValue
	Angle : SerializableNormalizationValue
@typetree_defined
class SerializableOutput(MonoBehaviour):
	...
	Reflect : bool
@typetree_defined
class SerializableParameterGroups(MonoBehaviour):
	Id : str
	GroupId : str
	Name : str
@typetree_defined
class SerializableParameters(MonoBehaviour):
	Id : str
	GroupId : str
	Name : str
@typetree_defined
class SerializableParts(MonoBehaviour):
	Id : str
	Name : str
@typetree_defined
class SerializableVertex(MonoBehaviour):
	...
	Radius : float
@typetree_defined
class SerializablePhysicsSettings(MonoBehaviour):
	Id : str
	Input : List[SerializableInput]
	Output : List[SerializableOutput]
	Vertices : List[SerializableVertex]
	Normalization : SerializableNormalization
@typetree_defined
class SerializablePoseGroup(MonoBehaviour):
	Id : str
	Link : List[str]
@typetree_defined
class SerializableUserData(MonoBehaviour):
	Time : float
	Value : str
@typetree_defined
class SourcesItem(MonoBehaviour):
	pass
@typetree_defined
class SubRigPhysicsOutput(MonoBehaviour):
	Output : List[float]
@typetree_defined
class SwapInfo(MonoBehaviour):
	pass
@typetree_defined
class TaskState(MonoBehaviour):
	value__ : int
@typetree_defined
class TexturePicker(MonoBehaviour):
	pass
@typetree_defined
class UnitySourceGeneratedAssemblyMonoScriptTypes_v1(MonoBehaviour):
	pass
@typetree_defined
class UnmanagedLogDelegate(MonoBehaviour):
	pass
@typetree_defined
class ValueGetter(MonoBehaviour):
	pass

TYPETREE_DEFS = {
    "__StaticArrayInitTypeSize=10454": [
        {
    ...
    "__StaticArrayInitTypeSize=9233": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Framework.CubismDisplayInfoParameterName": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Framework.CubismDisplayInfoPartName": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Framework.CubismUpdateExecutionOrder": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Framework.Expression.CubismExpressionController": [
        ...
        {
            "m_Type": "bool",
            "m_Name": "UseLegacyBlendCalculation",
            "m_MetaFlag": 16384,
            "m_Level": 1
        },
        {
    ...
    "Live2D.Cubism.Framework.Expression.CubismExpressionParameterValue": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
        ...
        {
            "m_Type": "float",
            "m_Name": "AdditiveValue",
            "m_MetaFlag": 0,
            "m_Level": 1
        },
        {
            "m_Type": "float",
            "m_Name": "MultiplyValue",
            "m_MetaFlag": 0,
            "m_Level": 1
        },
        {
            "m_Type": "float",
            "m_Name": "OverwriteValue",
            "m_MetaFlag": 0,
            "m_Level": 1
        }
    ],
    ...
    "Live2D.Cubism.Framework.Json.CubismDisplayInfo3Json": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
        ...
        {
            "m_Type": "SerializableParameterGroups[]",
            "m_Name": "ParameterGroups",
            "m_MetaFlag": 0,
            "m_Level": 1
        },
        {
        ...
        {
            "m_Type": "SerializableCombinedParameterIds[]",
            "m_Name": "CombinedParameters",
            "m_MetaFlag": 0,
            "m_Level": 1
        },
        {
    ...
    "Live2D.Cubism.Framework.Json.CubismPhysics3Json": [
        ...
        {
            "m_Type": "PhysicsDictionaryItem[]",
            "m_Name": "PhysicsDictionary",
            "m_MetaFlag": 0,
            "m_Level": 2
        },
        {
    ...
    "Live2D.Cubism.Framework.Motion.CubismMotionPriority": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Framework.Utils.CubismMath": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Rendering.CubismPartColorsEditor": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
        ...
        {
            "m_Type": "CubismRenderer[]",
            "m_Name": "_childDrawableRenderers",
            "m_MetaFlag": 0,
            "m_Level": 1
        },
        {
        ...
        {
            "m_Type": "PPtr<CubismPartColorsEditor>",
            "m_Name": "data",
            "m_MetaFlag": 0,
            "m_Level": 3
        },
        ...
        {
            "m_Type": "bool",
            "m_Name": "_isOverwrittenPartMultiplyColors",
            "m_MetaFlag": 16384,
            "m_Level": 1
        },
        {
            "m_Type": "bool",
            "m_Name": "_isOverwrittenPartScreenColors",
            "m_MetaFlag": 16384,
            "m_Level": 1
        },
        {
            "m_Type": "Color",
            "m_Name": "_multiplyColor",
            "m_MetaFlag": 16384,
            "m_Level": 1
        },
        {
    ...
    "Live2D.Cubism.Rendering.CubismRenderController": [
        ...
        {
            "m_Type": "bool",
            "m_Name": "_isOverwrittenModelMultiplyColors",
            "m_MetaFlag": 16384,
            "m_Level": 1
        },
        {
            "m_Type": "bool",
            "m_Name": "_isOverwrittenModelScreenColors",
            "m_MetaFlag": 16384,
            "m_Level": 1
        },
        {
            "m_Type": "Color",
            "m_Name": "_modelMultiplyColor",
            "m_MetaFlag": 16384,
            "m_Level": 1
        },
        {
    ...
    "Live2D.Cubism.Rendering.CubismRenderer": [
        ...
        {
            "m_Type": "bool",
            "m_Name": "_isOverwrittenDrawableMultiplyColors",
            "m_MetaFlag": 16384,
            "m_Level": 1
        },
        {
            "m_Type": "bool",
            "m_Name": "_isOverwrittenDrawableScreenColors",
            "m_MetaFlag": 16384,
            "m_Level": 1
        },
        {
    ...
    "Live2D.Cubism.Rendering.ICubismBlendColorHandler": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Samples.AsyncBenchmark.BenchmarkController": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
        ...
        {
            "m_Type": "SInt32",
            "m_Name": "TargetFrameRate",
            "m_MetaFlag": 0,
            "m_Level": 1
        },
        {
            "m_Type": "PPtr<Text>",
            "m_Name": "ReachedElapsedTimeUi",
            "m_MetaFlag": 0,
            "m_Level": 1
        },
        {
    ...
    "Live2D.Cubism.Samples.AsyncBenchmark.FrameRateMeasurer": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Samples.AsyncBenchmark.FrameRateUiHolder": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
        ...
        {
            "m_Type": "bool",
            "m_Name": "HasShownFrameRate",
            "m_MetaFlag": 16384,
            "m_Level": 1
        },
        {
            "m_Type": "bool",
            "m_Name": "HasShownElapsedTime",
            "m_MetaFlag": 16384,
            "m_Level": 1
        },
        {
            "m_Type": "PPtr<Text>",
            "m_Name": "HighestFrameRateUi",
            "m_MetaFlag": 0,
            "m_Level": 1
        },
        {
    ...
    "Live2D.Cubism.Samples.AsyncBenchmark.TotalElapsedTime": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Samples.OriginalWorkflow.Demo.CubismLookTarget": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Samples.OriginalWorkflow.Demo.CubismSampleController": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
        ...
        {
            "m_Type": "PPtr<AnimationClip>",
            "m_Name": "_bodyAnimation",
            "m_MetaFlag": 0,
            "m_Level": 1
        },
        {
        ...
        {
            "m_Type": "AnimationClip[]",
            "m_Name": "_tapBodyMotions",
            "m_MetaFlag": 0,
            "m_Level": 1
        },
        {
    ...
    "Live2D.Cubism.Samples.OriginalWorkflow.Expression.CubismExpressionPreview": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Samples.OriginalWorkflow.Motion.CubismMotionPreview": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "NormalizedParameterValueGetter": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "SerializableCombinedParameterIds": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Garage.CheckMaskLimit": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Garage.CubismCollisionDetection": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Garage.CubismFollowing": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Garage.CubismFollowingCollider": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
    ...
    "Live2D.Cubism.Garage.CubismSetTextures": [
        {
            "m_Type": "MonoBehaviour",
            "m_Name": "Base",
            "m_MetaFlag": 0,
