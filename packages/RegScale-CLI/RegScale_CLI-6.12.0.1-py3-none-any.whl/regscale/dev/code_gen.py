...
SUPPORTED_CONNECTORS = [ConnectorType.Ticketing, ConnectorType.Vulnerabilities]
...
def _build_click_options_and_command(
    ...
    if connector == ConnectorType.Vulnerabilities:
        ...
        scan_date_option = f"@click.option(\n    '--scan_date',\n    help='The date of the scan to sync vulnerabilities from {doc_string_name}',\n    required=False,\n    type=click.DateTime(formats=['%Y-%m-%d']),\n    default=None)\n"
        all_vulns_flag = f"@click.option(\n    '--all_scans',\n    help='Whether to sync all vulnerabilities from {doc_string_name}',\n    required=False,\n    is_flag=True,\n    default=False)\n"
