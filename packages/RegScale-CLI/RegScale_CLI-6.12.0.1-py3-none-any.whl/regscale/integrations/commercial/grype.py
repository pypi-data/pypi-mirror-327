...
def import_grype_scans(
    ...
    :param folder_path: Path to the Grype scan results JSON file
    :param regscale_ssp_id: RegScale SSP ID
    :param scan_date: The date of the scan
    :param mappings_path: Path to the header mapping file
    :param disable_mapping: Disable the header mapping
