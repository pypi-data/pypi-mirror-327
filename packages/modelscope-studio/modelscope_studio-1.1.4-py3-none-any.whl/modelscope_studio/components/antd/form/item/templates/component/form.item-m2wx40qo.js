import { i as me, a as M, r as pe, g as he, w as O, b as ge } from "./Index-I_VEV6TT.js";
...
var ye = /^\s+/;
function ve(e) {
  return e && e.slice(0, Ee(e) + 1).replace(ye, "");
}
...
function je(e, t, s) {
  var i, o, n, r, l, a, h = 0, _ = !1, c = !1, g = !0;
  if (typeof e != "function")
    throw new TypeError(Fe);
  t = G(t) || 0, M(s) && (_ = !!s.leading, c = "maxWait" in s, n = c ? Oe(G(s.maxWait) || 0, t) : n, g = "trailing" in s ? !!s.trailing : g);
  function m(p) {
    var E = i, F = o;
    return i = o = void 0, h = p, r = e.apply(F, E), r;
  }
  function w(p) {
    return h = p, l = setTimeout(f, t), _ ? m(p) : r;
  }
  function C(p) {
  ...
  function x(p) {
    return l = void 0, g && i ? m(p) : (i = o = void 0, r);
  }
  function R() {
...
const v = ae(({
  ...
  }, [e, _, s, i, n, o]), I.createElement("react-child", {
    ref: r,
    style: {
      display: "contents"
    }
  ...
  if (i.length !== 0)
    return i.map((o, n) => {
      ...
      Object.keys(o.slots).forEach((_) => {
        ...
        g instanceof Element ? m = g : (m = g.el, w = g.callback, C = g.clone ?? C, u = g.forceClone ?? u), u = u ?? !!w, l[c[c.length - 1]] = m ? w ? (...f) => (w(c[c.length - 1], f), /* @__PURE__ */ b.jsx(V, {
          ...o.ctx,
          params: f,
          forceClone: u,
          children: /* @__PURE__ */ b.jsx(v, {
            slot: m,
            clone: C
          })
...
const te = ({
  ...
  const _ = e["tooltip.icon"] || e["tooltip.title"] || typeof n == "object", c = typeof a == "object", g = ee(a), m = P(g.icons), w = P(t), C = P(s), u = P(i), f = P(o), x = ee(n), R = P(x.afterOpenChange), d = P(x.getPopupContainer), {
    items: {
      rules: y
    }
  } = mt();
  return /* @__PURE__ */ b.jsx(be.Item, {
    ...
    rules: z(() => {
      var p;
      return (p = r || ce(y)) == null ? void 0 : p.map((E) => pt(E));
    }, [y, r]),
    tooltip: e.tooltip ? /* @__PURE__ */ b.jsx(v, {
      slot: e.tooltip
    }) : _ ? {
      ...x,
      afterOpenChange: R,
      getPopupContainer: d,
      icon: e["tooltip.icon"] ? /* @__PURE__ */ b.jsx(v, {
        slot: e["tooltip.icon"]
      }) : x.icon,
      title: e["tooltip.title"] ? /* @__PURE__ */ b.jsx(v, {
        slot: e["tooltip.title"]
      }) : x.title
    } : n,
    extra: e.extra ? /* @__PURE__ */ b.jsx(v, {
      slot: e.extra
    }) : h.extra,
    help: e.help ? /* @__PURE__ */ b.jsx(v, {
      slot: e.help
    }) : h.help,
    label: e.label ? /* @__PURE__ */ b.jsx(v, {
      slot: e.label
    }) : h.label,
