import { i as de, a as B, r as fe, g as pe, w as k, d as me, b as R } from "./Index-C1HMy_Ga.js";
...
function V(e) {
  ...
  e = Ce(e);
  var s = we.test(e);
  return s || ye.test(e) ? Ie(e.slice(2), s ? 2 : 8) : Ee.test(e) ? z : +e;
}
var A = function() {
  return fe.Date.now();
}, ve = "Expected a function", Se = Math.max, Te = Math.min;
function Oe(e, t, s) {
...
const I = ce(({
  ...
  return te(() => {
    ...
    if (h && window.MutationObserver) {
      let u = function() {
        var d, v, m;
        (d = r.current) != null && d.contains(a) && ((v = r.current) == null || v.removeChild(a));
        const {
          portals: E,
          clonedElement: T
        } = D(e);
...
const {
  ...
  useItems: dt,
  ItemHandler: pt
} = he("antd-tabs-items"), mt = et(ut(["tabList"], ({
  children: e,
  containsGrid: t,
  slots: s,
  tabList: l,
  ...
  return /* @__PURE__ */ x.jsxs(H, {
    ...
    title: s.title ? /* @__PURE__ */ x.jsx(I, {
      slot: s.title
    }) : n.title,
    extra: s.extra ? /* @__PURE__ */ x.jsx(I, {
      slot: s.extra
    }) : n.extra,
    cover: s.cover ? /* @__PURE__ */ x.jsx(I, {
      slot: s.cover
    }) : n.cover,
    tabBarExtraContent: s.tabBarExtraContent ? /* @__PURE__ */ x.jsx(I, {
      slot: s.tabBarExtraContent
    }) : n.tabBarExtraContent,
    actions: r.length > 0 ? r.map((c, _) => /* @__PURE__ */ x.jsx(I, {
      slot: c
    }, _)) : n.actions,
