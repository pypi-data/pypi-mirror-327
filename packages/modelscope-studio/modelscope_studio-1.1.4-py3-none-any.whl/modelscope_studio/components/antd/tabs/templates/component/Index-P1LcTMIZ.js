...
var xt = typeof exports == "object" && exports && !exports.nodeType && exports, Je = xt && typeof module == "object" && module && !module.nodeType && module, tr = Je && Je.exports === xt, Xe = tr ? C.Buffer : void 0, nr = Xe ? Xe.isBuffer : void 0, re = nr || er, rr = "[object Arguments]", ir = "[object Array]", or = "[object Boolean]", ar = "[object Date]", sr = "[object Error]", ur = "[object Function]", lr = "[object Map]", cr = "[object Number]", fr = "[object Object]", pr = "[object RegExp]", gr = "[object Set]", dr = "[object String]", _r = "[object WeakMap]", br = "[object ArrayBuffer]", hr = "[object DataView]", yr = "[object Float32Array]", mr = "[object Float64Array]", vr = "[object Int8Array]", Tr = "[object Int16Array]", Or = "[object Int32Array]", Pr = "[object Uint8Array]", wr = "[object Uint8ClampedArray]", $r = "[object Uint16Array]", Ar = "[object Uint32Array]", v = {};
...
var me = K(C, "DataView"), ve = K(C, "Promise"), Te = K(C, "Set"), tt = "[object Map]", Yi = "[object Object]", nt = "[object Promise]", rt = "[object Set]", it = "[object WeakMap]", ot = "[object DataView]", Ji = D(me), Xi = D(X), Zi = D(ve), Wi = D(Te), Qi = D(be), $ = N;
(me && $(new me(new ArrayBuffer(1))) != ot || X && $(new X()) != tt || ve && $(ve.resolve()) != nt || Te && $(new Te()) != rt || be && $(new be()) != it) && ($ = function(e) {
...
function ee(e, t, n, r, i, o) {
  ...
  return Bn(_ || e, function(c, b) {
    _ && (b = c, c = e[b]), At(a, b, ee(c, t, n, b, e, o));
  }), a;
}
...
var _a = 1, ba = 2, ha = "[object Boolean]", ya = "[object Date]", ma = "[object Error]", va = "[object Map]", Ta = "[object Number]", Oa = "[object RegExp]", Pa = "[object Set]", wa = "[object String]", $a = "[object Symbol]", Aa = "[object ArrayBuffer]", Sa = "[object DataView]", ct = w ? w.prototype : void 0, ge = ct ? ct.valueOf : void 0;
...
var Fa = 1, ft = "[object Arguments]", pt = "[object Array]", k = "[object Object]", Ma = Object.prototype, gt = Ma.hasOwnProperty;
            ...
            try {
              ...
              return he(b) ? Object.fromEntries(Object.entries(b).map(([T, P]) => {
                try {
                  ...
                  return he(P) ? [T, Object.fromEntries(Object.entries(P).filter(([F, M]) => {
                    try {
...
function Vs(e, t, n) {
  ...
  const g = ls(() => import("./tabs-BpFGW50X.js"));
  let {
    gradio: p
  } = t, {
    props: f = {}
  ...
  return de(e, Ke, (h) => n(1, s = h)), e.$$set = (h) => {
    t = Oe(Oe({}, t), Rs(h)), n(19, i = ht(t, r)), "gradio" in h && n(7, p = h.gradio), "props" in h && n(8, f = h.props), "_internal" in h && n(9, m = h._internal), "as_item" in h && n(10, _ = h.as_item), "visible" in h && n(11, c = h.visible), "elem_id" in h && n(12, b = h.elem_id), "elem_classes" in h && n(13, T = h.elem_classes), "elem_style" in h && n(14, P = h.elem_style), "$$scope" in h && n(17, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    256 && d.update((h) => ({
      ...h,
  ...
  }, [a, s, g, d, F, nn, Ke, p, f, m, _, c, b, T, P, o, u, l];
}
class tu extends Es {
  constructor(t) {
