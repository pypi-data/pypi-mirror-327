import { i as fe, a as D, r as me, b as he, g as _e, w as j, c as ge } from "./Index-D9_bcn8x.js";
...
var z = NaN, Ie = /^[-+]0x[0-9a-f]+$/i, Re = /^0b[01]+$/i, Se = /^0o[0-7]+$/i, Pe = parseInt;
function G(t) {
  if (typeof t == "number")
    return t;
  if (fe(t))
  ...
  t = ve(t);
  var r = Re.test(t);
  return r || Se.test(t) ? Pe(t.slice(2), r ? 2 : 8) : Ie.test(t) ? z : +t;
}
var F = function() {
  return me.Date.now();
...
function Te(t, e, r) {
  ...
  function f(h) {
    var E = s, P = l;
    return s = l = void 0, C = h, o = t.apply(P, E), o;
  }
  function w(h) {
    return C = h, c = setTimeout(d, e), g ? f(h) : o;
  }
  function b(h) {
    var E = h - u, P = h - C, q = e - E;
    return i ? Oe(q, n - P) : q;
  }
  function a(h) {
    var E = h - u, P = h - C;
    return u === void 0 || E >= e || E < 0 || i && P >= n;
  }
  function d() {
    var h = F();
    if (a(h))
 ...
 */
var Ae = y, Le = Symbol.for("react.element"), We = Symbol.for("react.fragment"), Ne = Object.prototype.hasOwnProperty, Me = Ae.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, De = {
  key: !0,
  ref: !0,
  __self: !0,
  __source: !0
  ...
  return {
    ...
    l(o) {
      e = ce(o, "REACT-PORTAL-TARGET", {
        class: !0
      }), se(e).forEach(S), r = Be(o), n && n.l(o), s = K(), this.h();
    },
    h() {
      ae(e, "class", "svelte-1rt0kpf");
    },
...
const I = ne(({
  ...
  return N(() => {
    ...
    if (g && window.MutationObserver) {
      let a = function() {
        var m, R, h;
        (m = o.current) != null && m.contains(i) && ((R = o.current) == null || R.removeChild(i));
        const {
          portals: x,
          clonedElement: v
        } = B(t);
        i = v, u(x), i.style.display = "contents", w && clearTimeout(w), w = setTimeout(() => {
          p();
  ...
  }, [t, g, r, s, n, l]), y.createElement("react-child", {
    ref: o,
    style: {
      display: "contents"
    }
