import { i as ce, a as W, r as ae, g as ue, w as O, d as de, b as T, c as fe } from "./Index-Bba6_ijE.js";
...
function Se(e, t, o) {
  ...
  t = z(t) || 0, W(o) && (g = !!o.leading, c = "maxWait" in o, n = c ? ve(z(o.maxWait) || 0, t) : n, h = "trailing" in o ? !!o.trailing : h);
  function p(d) {
    var y = i, S = s;
  ...
  return {
    ...
    l(r) {
      t = re(r, "REACT-PORTAL-TARGET", {
        class: !0
      }), ne(t).forEach(v), o = Ne(r), n && n.l(r), i = V(), this.h();
    },
    h() {
      se(t, "class", "svelte-1rt0kpf");
    },
...
const st = ie(({
  ...
  return $(() => {
    ...
    if (g && window.MutationObserver) {
      let f = function() {
        var u, E, d;
        (u = r.current) != null && u.contains(c) && ((E = r.current) == null || E.removeChild(c));
        const {
          portals: b,
          clonedElement: I
        } = M(e);
