...
var me = K(x, "DataView"), ve = K(x, "Promise"), Te = K(x, "Set"), tt = "[object Map]", Yi = "[object Object]", nt = "[object Promise]", rt = "[object Set]", it = "[object WeakMap]", ot = "[object DataView]", Ji = D(me), Xi = D(J), Zi = D(ve), Wi = D(Te), Qi = D(he), A = N;
...
var _a = 1, ha = 2, ba = "[object Boolean]", ya = "[object Date]", ma = "[object Error]", va = "[object Map]", Ta = "[object Number]", Oa = "[object RegExp]", wa = "[object Set]", Pa = "[object String]", Aa = "[object Symbol]", $a = "[object ArrayBuffer]", Sa = "[object DataView]", ct = P ? P.prototype : void 0, ge = ct ? ct.valueOf : void 0;
...
function Ws(e, t, n) {
  ...
  const g = ls(() => import("./popover-Btk4iTqp.js"));
  let {
    gradio: p
  } = t, {
    props: f = {}
  ...
  return de(e, Ke, (h) => n(1, s = h)), e.$$set = (h) => {
    t = Oe(Oe({}, t), Ms(h)), n(19, i = bt(t, r)), "gradio" in h && n(6, p = h.gradio), "props" in h && n(7, f = h.props), "_internal" in h && n(8, m = h._internal), "content" in h && n(9, _ = h.content), "as_item" in h && n(10, c = h.as_item), "visible" in h && n(11, b = h.visible), "elem_id" in h && n(12, T = h.elem_id), "elem_classes" in h && n(13, w = h.elem_classes), "elem_style" in h && n(14, S = h.elem_style), "$$scope" in h && n(17, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && d.update((h) => ({
      ...h,
  ...
  }, [a, s, g, d, E, Ke, p, f, m, _, c, b, T, w, S, o, u, l];
}
class ks extends Cs {
  constructor(t) {
