...
function Ws(e, t, n) {
  ...
  const g = ls(() => import("./descriptions-D0JcbEDg.js"));
  let {
    gradio: p
  } = t, {
    props: c = {}
  ...
  return de(e, Ke, (h) => n(1, s = h)), e.$$set = (h) => {
    t = Oe(Oe({}, t), Fs(h)), n(19, i = bt(t, r)), "gradio" in h && n(6, p = h.gradio), "props" in h && n(7, c = h.props), "_internal" in h && n(8, m = h._internal), "title" in h && n(9, _ = h.title), "as_item" in h && n(10, f = h.as_item), "visible" in h && n(11, b = h.visible), "elem_id" in h && n(12, T = h.elem_id), "elem_classes" in h && n(13, w = h.elem_classes), "elem_style" in h && n(14, S = h.elem_style), "$$scope" in h && n(17, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && d.update((h) => ({
      ...h,
