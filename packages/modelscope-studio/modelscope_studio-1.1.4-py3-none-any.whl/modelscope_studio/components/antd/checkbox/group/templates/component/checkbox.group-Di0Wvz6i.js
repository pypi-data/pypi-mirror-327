import { i as ae, a as A, r as ue, g as de, w as O } from "./Index-BJ-5fX_2.js";
...
function Se(e, t, s) {
  ...
  function f(p) {
    var y = l, k = o;
    return l = o = void 0, g = p, r = e.apply(k, y), r;
  }
  function b(p) {
    return g = p, i = setTimeout(m, t), _ ? f(p) : r;
  }
  function x(p) {
    var y = p - a, k = p - g, F = t - y;
    return c ? Ie(F, n - k) : F;
  }
  function u(p) {
    var y = p - a, k = p - g;
    return a === void 0 || y >= t || y < 0 || c && k >= n;
  }
  function m() {
    var p = j();
    if (u(p))
 ...
 */
var ke = C, Oe = Symbol.for("react.element"), Re = Symbol.for("react.fragment"), Te = Object.prototype.hasOwnProperty, Pe = ke.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, je = {
  key: !0,
  ref: !0,
  __self: !0,
  __source: !0
...
const {
  ...
  useItems: lt,
  ItemHandler: ct
} = pe("antd-checkbox-group-options"), at = Ze(st(["default", "options"], ({
  onValueChange: e,
  onChange: t,
  elRef: s,
  options: l,
