import { i as ue, a as W, r as de, g as fe, w as k, b as me } from "./Index-Chwlj1ts.js";
...
var U = NaN, ye = /^[-+]0x[0-9a-f]+$/i, Ce = /^0b[01]+$/i, Ee = /^0o[0-7]+$/i, ve = parseInt;
function z(e) {
  if (typeof e == "number")
    return e;
  if (ue(e))
  ...
  e = we(e);
  var o = Ce.test(e);
  return o || Ee.test(e) ? ve(e.slice(2), o ? 2 : 8) : ye.test(e) ? U : +e;
}
var L = function() {
  return de.Date.now();
}, Ie = "Expected a function", Pe = Math.max, Te = Math.min;
function Re(e, t, o) {
  var i, l, n, r, s, u, h = 0, p = !1, c = !1, x = !0;
  if (typeof e != "function")
    throw new TypeError(Ie);
  t = z(t) || 0, W(o) && (p = !!o.leading, c = "maxWait" in o, n = c ? Pe(z(o.maxWait) || 0, t) : n, x = "trailing" in o ? !!o.trailing : x);
  function f(d) {
    var C = i, R = l;
    return i = l = void 0, h = d, r = e.apply(R, C), r;
  }
  function E(d) {
    return h = d, s = setTimeout(g, t), p ? f(d) : r;
  }
  function v(d) {
    var C = d - u, R = d - h, D = t - C;
    return c ? Te(D, n - R) : D;
  }
  function m(d) {
    var C = d - u, R = d - h;
 ...
 */
var Se = y, ke = Symbol.for("react.element"), Oe = Symbol.for("react.fragment"), je = Object.prototype.hasOwnProperty, Fe = Se.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, Le = {
  key: !0,
  ref: !0,
  __self: !0,
  __source: !0
...
const Y = window.ms_globals.rerender, B = window.ms_globals.tree;
function et(e, t = {}) {
  function o(i) {
    const l = k(), n = new $e({
      ...i,
...
const w = le(({
  ...
  return ce(() => {
    ...
    if (p && window.MutationObserver) {
      let m = function() {
        ...
        c = T, u(b), c.style.display = "contents", E && clearTimeout(E), E = setTimeout(() => {
          x();
  ...
  }, [e, p, o, i, n, l]), y.createElement("react-child", {
    ref: r,
    style: {
      display: "contents"
    }
...
const ut = et(({
  ...
  return /* @__PURE__ */ _.jsx(ge, {
    ...
    okButtonProps: {
      ...
      }) : (x = s.okButtonProps) == null ? void 0 : x.icon
    },
    ...
    cancelButtonProps: {
      ...
      }) : (f = s.cancelButtonProps) == null ? void 0 : f.icon
    },
