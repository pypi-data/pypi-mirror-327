import { g as J, w as p } from "./Index-C0sfsHv5.js";
...
function pe(r) {
  ...
  return {
    c() {
      t = A("react-portal-target"), l = ie(), e && e.c(), n = S(), this.h();
    },
    l(s) {
      t = L(s, "REACT-PORTAL-TARGET", {
        class: !0
      }), D(t).forEach(_), l = ee(s), e && e.l(s), n = S(), this.h();
    },
    h() {
      F(t, "class", "svelte-1rt0kpf");
    },
...
const T = window.ms_globals.rerender, h = window.ms_globals.tree;
function be(r, t = {}) {
  function l(n) {
    const o = p(), e = new ge({
      ...n,
