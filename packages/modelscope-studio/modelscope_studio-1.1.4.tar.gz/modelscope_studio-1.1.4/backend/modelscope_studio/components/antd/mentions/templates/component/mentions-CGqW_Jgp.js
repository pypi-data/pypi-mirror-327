import { i as ue, a as A, r as de, b as fe, g as me, w as k, c as he } from "./Index-DIuMrCH7.js";
...
var q = NaN, ye = /^[-+]0x[0-9a-f]+$/i, Ce = /^0b[01]+$/i, ve = /^0o[0-7]+$/i, Ie = parseInt;
function z(e) {
  if (typeof e == "number")
    return e;
  if (ue(e))
  ...
  e = Ee(e);
  var s = Ce.test(e);
  return s || ve.test(e) ? Ie(e.slice(2), s ? 2 : 8) : ye.test(e) ? q : +e;
}
var j = function() {
  return de.Date.now();
}, Se = "Expected a function", Re = Math.max, ke = Math.min;
function Oe(e, t, s) {
  var l, r, n, o, i, u, _ = 0, p = !1, c = !1, g = !0;
  if (typeof e != "function")
    throw new TypeError(Se);
  t = z(t) || 0, A(s) && (p = !!s.leading, c = "maxWait" in s, n = c ? Re(z(s.maxWait) || 0, t) : n, g = "trailing" in s ? !!s.trailing : g);
  function f(h) {
    var y = l, R = r;
    return l = r = void 0, _ = h, o = e.apply(R, y), o;
  }
  function w(h) {
    return _ = h, i = setTimeout(d, t), p ? f(h) : o;
  }
  function b(h) {
    var y = h - u, R = h - _, B = t - y;
    return c ? ke(B, n - R) : B;
  }
  function a(h) {
    var y = h - u, R = h - _;
  ...
  function x(h) {
    return i = void 0, g && l ? f(h) : (l = r = void 0, o);
  }
  function S() {
 ...
 */
var Te = C, je = Symbol.for("react.element"), Fe = Symbol.for("react.fragment"), Le = Object.prototype.hasOwnProperty, Ne = Te.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, We = {
  key: !0,
  ref: !0,
  __self: !0,
  __source: !0
      ...
      props: {
        svelteInit(o) {
          ...
          return u.nodes = [...u.nodes, i], $({
            ...
            u.nodes = u.nodes.filter((_) => _.svelteInstance !== r), $({
              createPortal: M,
              node: F
            });
          }), i;
...
function V(e) {
  ...
  if (e._reactElement) {
    const r = C.Children.toArray(e._reactElement.props.children).map((n) => {
    ...
    return r.originalChildren = e._reactElement.props.children, t.push(M(C.cloneElement(e._reactElement, {
...
const U = ae(({
  ...
  return W(() => {
    ...
    if (p && window.MutationObserver) {
      let a = function() {
        var m, v, h;
        (m = o.current) != null && m.contains(c) && ((v = o.current) == null || v.removeChild(c));
        const {
          portals: x,
          clonedElement: S
        } = V(e);
        c = S, u(x), c.style.display = "contents", w && clearTimeout(w), w = setTimeout(() => {
          g();
        }, 50), (h = o.current) == null || h.appendChild(c);
      };
      a();
      const d = Oe(() => {
  ...
  }, [e, p, s, l, n, r]), C.createElement("react-child", {
    ref: o,
    style: {
      display: "contents"
    }
  ...
  if (l.length !== 0)
    return l.map((r, n) => {
      ...
      Object.keys(r.slots).forEach((p) => {
        ...
        g instanceof Element ? f = g : (f = g.el, w = g.callback, b = g.clone ?? b, a = g.forceClone ?? a), a = a ?? !!w, i[c[c.length - 1]] = f ? w ? (...d) => (w(c[c.length - 1], d), /* @__PURE__ */ E.jsx(H, {
          ...r.ctx,
          params: d,
          forceClone: a,
...
const {
  ...
  ItemHandler: _t
} = ge("antd-mentions-options"), pt = nt(mt(["options", "default"], ({
  slots: e,
  children: t,
  onValueChange: s,
  filterOption: l,
