...
function te(e, t, n, r, i, o) {
  ...
  var _ = l ? u ? Kt : ye : u ? Ee : Q, b = g ? void 0 : _(e);
  return Bn(b || e, function(c, h) {
    b && (h = c, c = e[h]), $t(a, h, te(c, t, n, h, e, o));
  }), a;
}
...
function ks(e, t, n) {
  ...
  const g = ls(() => import("./list.item-D-3kiu2w.js"));
  let {
    gradio: p
  } = t, {
    _internal: f = {}
  ...
  return de(e, Ke, (y) => n(1, s = y)), e.$$set = (y) => {
    t = Oe(Oe({}, t), Ns(y)), n(18, i = ht(t, r)), "gradio" in y && n(6, p = y.gradio), "_internal" in y && n(7, f = y._internal), "as_item" in y && n(8, d = y.as_item), "props" in y && n(9, _ = y.props), "elem_id" in y && n(10, c = y.elem_id), "elem_classes" in y && n(11, h = y.elem_classes), "elem_style" in y && n(12, T = y.elem_style), "visible" in y && n(13, w = y.visible), "$$scope" in y && n(16, l = y.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    512 && b.update((y) => ({
      ...y,
  ...
  }, [a, s, g, b, M, Ke, p, f, d, _, c, h, T, w, o, u, l];
}
class ru extends js {
  constructor(t) {
