...
var mt = typeof global == "object" && global && global.Object === Object && global, on = typeof self == "object" && self && self.Object === Object && self, C = mt || on || Function("return this")(), O = C.Symbol, vt = Object.prototype, an = vt.hasOwnProperty, sn = vt.toString, q = O ? O.toStringTag : void 0;
function un(e) {
...
var pn = "[object Null]", gn = "[object Undefined]", Ue = O ? O.toStringTag : void 0;
function N(e) {
...
var A = Array.isArray, _n = 1 / 0, Ge = O ? O.prototype : void 0, ze = Ge ? Ge.toString : void 0;
function wt(e) {
  if (typeof e == "string")
    return e;
  if (A(e))
...
v[yr] = v[mr] = v[vr] = v[Tr] = v[wr] = v[Pr] = v[Or] = v[$r] = v[Ar] = !0;
...
var Le = Ft(Object.getPrototypeOf, Object), Oi = "[object Object]", $i = Function.prototype, Ai = Object.prototype, Mt = $i.toString, Si = Ai.hasOwnProperty, Ci = Mt.call(Object);
function be(e) {
  if (!E(e) || N(e) != Oi)
    return !1;
  var t = Le(e);
...
var _a = 1, ha = 2, ba = "[object Boolean]", ya = "[object Date]", ma = "[object Error]", va = "[object Map]", Ta = "[object Number]", wa = "[object RegExp]", Pa = "[object Set]", Oa = "[object String]", $a = "[object Symbol]", Aa = "[object ArrayBuffer]", Sa = "[object DataView]", ft = O ? O.prototype : void 0, ge = ft ? ft.valueOf : void 0;
...
function Vs(e, t, n) {
  ...
  const g = ls(() => import("./pagination-CdedIWql.js"));
  let {
    gradio: p
  } = t, {
    props: c = {}
  ...
  return de(e, Ke, (b) => n(1, s = b)), e.$$set = (b) => {
    t = we(we({}, t), Rs(b)), n(19, i = bt(t, r)), "gradio" in b && n(7, p = b.gradio), "props" in b && n(8, c = b.props), "_internal" in b && n(9, m = b._internal), "as_item" in b && n(10, _ = b.as_item), "visible" in b && n(11, f = b.visible), "elem_id" in b && n(12, h = b.elem_id), "elem_classes" in b && n(13, T = b.elem_classes), "elem_style" in b && n(14, P = b.elem_style), "$$scope" in b && n(17, l = b.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    256 && d.update((b) => ({
      ...b,
  ...
  }, [a, s, g, d, F, nn, Ke, p, c, m, _, f, h, T, P, o, u, l];
}
class tu extends Es {
  constructor(t) {
