import { b as Y, g as H, w as m } from "./Index-BSGY0oXo.js";
...
function he(l) {
  ...
  return {
    c() {
      e = L("react-portal-target"), r = me(), t && t.c(), o = x(), this.h();
    },
    l(n) {
      e = F(n, "REACT-PORTAL-TARGET", {
        class: !0
      }), D(e).forEach(u), r = le(n), t && t.l(n), o = x(), this.h();
    },
    h() {
      N(e, "class", "svelte-1rt0kpf");
    },
    ...
    p(n, [a]) {
      ...
      16 && b(t, 1)) : (t = C(n), t.c(), b(t, 1), t.m(o.parentNode, o)) : t && (_e(), v(t, 1, 1, () => {
        t = null;
      }), re());
    },
    i(n) {
...
function Ie(l, e, r) {
  ...
  return l.$$set = (c) => {
    r(17, e = R(R({}, e), S(c))), "svelteInit" in c && r(5, i = c.svelteInit), "$$scope" in c && r(6, n = c.$$scope);
  }, e = S(e), [o, s, f, d, a, i, n, t, z, B];
}
class ye extends se {
  constructor(e) {
