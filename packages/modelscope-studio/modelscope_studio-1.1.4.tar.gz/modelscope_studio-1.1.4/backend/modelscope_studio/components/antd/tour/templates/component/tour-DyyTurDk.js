import { i as fe, a as W, r as me, g as _e, w as P, b as he } from "./Index-xdkIYKT4.js";
...
var ye = /^\s+/;
function Ee(t) {
  return t && t.slice(0, we(t) + 1).replace(ye, "");
}
var B = NaN, ve = /^[-+]0x[0-9a-f]+$/i, Ce = /^0b[01]+$/i, Ie = /^0o[0-7]+$/i, Se = parseInt;
function H(t) {
  if (typeof t == "number")
    return t;
  if (fe(t))
  ...
  t = Ee(t);
  var o = Ce.test(t);
  return o || Ie.test(t) ? Se(t.slice(2), o ? 2 : 8) : ve.test(t) ? B : +t;
}
var L = function() {
  return me.Date.now();
}, Re = "Expected a function", Te = Math.max, Pe = Math.min;
function Oe(t, e, o) {
  var l, s, n, r, i, a, g = 0, p = !1, c = !1, h = !0;
  if (typeof t != "function")
    throw new TypeError(Re);
  e = H(e) || 0, W(o) && (p = !!o.leading, c = "maxWait" in o, n = c ? Te(H(o.maxWait) || 0, e) : n, h = "trailing" in o ? !!o.trailing : h);
  function u(_) {
    var v = l, R = s;
    return l = s = void 0, g = _, r = t.apply(R, v), r;
  }
  function b(_) {
    return g = _, i = setTimeout(m, e), p ? u(_) : r;
  }
  function w(_) {
    var v = _ - a, R = _ - g, U = e - v;
    return c ? Pe(U, n - R) : U;
  }
  function d(_) {
    var v = _ - a, R = _ - g;
 ...
 */
var ke = E, je = Symbol.for("react.element"), Le = Symbol.for("react.fragment"), Fe = Object.prototype.hasOwnProperty, Ne = ke.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, We = {
  key: !0,
  ref: !0,
  __self: !0,
  __source: !0
  ...
  return de(() => {
    ...
    if (p && window.MutationObserver) {
      let d = function() {
        ...
        c = S, a(y), c.style.display = "contents", b && clearTimeout(b), b = setTimeout(() => {
          h();
  ...
  if (l.length !== 0)
    return l.map((s, n) => {
      ...
      Object.keys(s.slots).forEach((p) => {
        ...
        const h = s.slots[p];
        let u, b, w = !1, d = e == null ? void 0 : e.forceClone;
        h instanceof Element ? u = h : (u = h.el, b = h.callback, w = h.clone ?? w, d = h.forceClone ?? d), d = d ?? !!b, i[c[c.length - 1]] = u ? b ? (...m) => (b(c[c.length - 1], m), /* @__PURE__ */ x.jsx(A, {
          ...s.ctx,
          params: m,
          forceClone: d,
...
function Z(t, e) {
  return t ? e != null && e.forceClone || e != null && e.params ? le((o) => /* @__PURE__ */ x.jsx(A, {
...
function ut({
  ...
  return e[t] ? (...s) => o ? o.map((n, r) => /* @__PURE__ */ x.jsx(E.Fragment, {
    children: Z(n, {
      clone: !0,
      params: s,
      forceClone: !0
...
const {
  ...
  useItems: ft,
  ItemHandler: _t
} = xe("antd-tour-items"), ht = nt(dt(["steps", "default"], ({
  slots: t,
  steps: e,
  children: o,
  onChange: l,
  ...
  return /* @__PURE__ */ x.jsxs(x.Fragment, {
    children: [/* @__PURE__ */ x.jsx("div", {
      ...
      closeIcon: t.closeIcon ? /* @__PURE__ */ x.jsx(T, {
        slot: t.closeIcon
      }) : a.closeIcon,
