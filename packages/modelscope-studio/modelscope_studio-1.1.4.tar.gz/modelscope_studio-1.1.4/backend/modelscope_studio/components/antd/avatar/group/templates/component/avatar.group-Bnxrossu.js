import { i as ae, a as M, r as ce, g as ue, w as O, d as de, b as R } from "./Index-CckaR7ni.js";
  ...
  return {
    ...
    l(r) {
      t = re(r, "REACT-PORTAL-TARGET", {
        class: !0
      }), ne(t).forEach(C), o = je(r), n && n.l(r), i = V(), this.h();
    },
    h() {
      se(t, "class", "svelte-1rt0kpf");
    },
...
const N = ie(({
  ...
  return $(() => {
    ...
    if (g && window.MutationObserver) {
      let p = function() {
        var u, I, d;
        (u = r.current) != null && u.contains(a) && ((I = r.current) == null || I.removeChild(a));
        const {
          portals: x,
          clonedElement: S
        } = F(e);
