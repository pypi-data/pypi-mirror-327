import { i as fe, a as M, r as me, g as pe, w as k, d as _e, b as O, c as he } from "./Index-DL8Is3td.js";
...
function ke(e, t, o) {
  var l, s, n, r, i, u, h = 0, g = !1, c = !1, x = !0;
  if (typeof e != "function")
    throw new TypeError(Re);
  t = H(t) || 0, M(o) && (g = !!o.leading, c = "maxWait" in o, n = c ? Oe(H(o.maxWait) || 0, t) : n, x = "trailing" in o ? !!o.trailing : x);
  function p(f) {
    var C = l, R = s;
    return l = s = void 0, h = f, r = e.apply(R, C), r;
  }
  function y(f) {
    return h = f, i = setTimeout(a, t), g ? p(f) : r;
  }
  function v(f) {
    var C = f - u, R = f - h, z = t - C;
    return c ? Pe(z, n - R) : z;
  }
  function m(f) {
    var C = f - u, R = f - h;
  ...
  function T() {
    i !== void 0 && clearTimeout(i), h = 0, l = u = s = i = void 0;
  }
  function d() {
    return i === void 0 ? r : b(A());
  }
  function E() {
    var f = A(), C = m(f);
      ...
      props: {
        svelteInit(r) {
          ...
          return u.nodes = [...u.nodes, i], Z({
            ...
            u.nodes = u.nodes.filter((h) => h.svelteInstance !== s), Z({
              createPortal: W,
              node: N
            });
          }), i;
  ...
  return re(() => {
    ...
    if (g && window.MutationObserver) {
      let m = function() {
        ...
        c = T, u(b), c.style.display = "contents", y && clearTimeout(y), y = setTimeout(() => {
          x();
...
const _t = rt(({
  ...
  return /* @__PURE__ */ _.jsxs(_.Fragment, {
    children: [/* @__PURE__ */ _.jsx("div", {
      ...
      titles: c.length > 0 ? c.map((a, b) => /* @__PURE__ */ _.jsx(S, {
        slot: a
      }, b)) : g.titles,
      listStyle: y || n,
      selectAllLabels: x.length > 0 ? x.map((a, b) => /* @__PURE__ */ _.jsx(S, {
        slot: a
      }, b)) : g.selectAllLabels
    })]
  });
