...
function Zs(e, t, n) {
  ...
  const d = us(() => import("./list.item.meta-c8n4aHUF.js"));
  let {
    gradio: p
  } = t, {
    _internal: c = {}
  ...
  return de(e, Ke, (b) => n(1, s = b)), e.$$set = (b) => {
    t = Oe(Oe({}, t), Ms(b)), n(18, i = bt(t, r)), "gradio" in b && n(6, p = b.gradio), "_internal" in b && n(7, c = b._internal), "as_item" in b && n(8, g = b.as_item), "props" in b && n(9, m = b.props), "elem_id" in b && n(10, f = b.elem_id), "elem_classes" in b && n(11, h = b.elem_classes), "elem_style" in b && n(12, T = b.elem_style), "visible" in b && n(13, w = b.visible), "$$scope" in b && n(16, l = b.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    512 && _.update((b) => ({
      ...b,
  ...
  }, [a, s, d, _, I, Ke, p, c, g, m, f, h, T, w, o, u, l];
}
class Vs extends Ss {
  constructor(t) {
