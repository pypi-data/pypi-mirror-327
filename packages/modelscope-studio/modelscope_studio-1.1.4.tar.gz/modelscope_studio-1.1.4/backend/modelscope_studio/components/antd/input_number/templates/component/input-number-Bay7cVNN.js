import { i as ce, a as M, r as ae, b as ue, g as de, w as O, c as fe } from "./Index-Bj0sGSsC.js";
...
function Re(e, t, r) {
  var i, s, n, o, l, u, p = 0, h = !1, c = !1, g = !0;
  if (typeof e != "function")
    throw new TypeError(Ie);
  t = q(t) || 0, M(r) && (h = !!r.leading, c = "maxWait" in r, n = c ? ve(q(r.maxWait) || 0, t) : n, g = "trailing" in r ? !!r.trailing : g);
  function m(d) {
    var x = i, T = s;
    return i = s = void 0, p = d, o = e.apply(T, x), o;
  }
  function y(d) {
    return p = d, l = setTimeout(_, t), h ? m(d) : o;
  }
  function I(d) {
    var x = d - u, T = d - p, V = t - x;
    return c ? Ce(V, n - T) : V;
  }
  function f(d) {
    var x = d - u, T = d - p;
  ...
  return {
    ...
    l(o) {
      t = re(o, "REACT-PORTAL-TARGET", {
        class: !0
      }), ne(t).forEach(R), r = Fe(o), n && n.l(o), i = K(), this.h();
    },
    h() {
      se(t, "class", "svelte-1rt0kpf");
    },
    ...
    d(o) {
      o && (R(t), R(r), R(i)), e[8](null), n && n.d(o);
    }
  };
}
function Y(e) {
...
const C = ie(({
  ...
  return F(() => {
    ...
    if (h && window.MutationObserver) {
      ...
      c.style.display = "contents", g(), (I = o.current) == null || I.appendChild(c);
    return () => {
      var f, _;
