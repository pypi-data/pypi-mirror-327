...
var he = K(x, "WeakMap"), He = Object.create, Fn = /* @__PURE__ */ function() {
  function e() {
  }
  return function(t) {
    if (!z(t))
...
var ha = 1, ba = 2, ya = "[object Boolean]", ma = "[object Date]", va = "[object Error]", Ta = "[object Map]", Oa = "[object Number]", wa = "[object RegExp]", Pa = "[object Set]", Aa = "[object String]", $a = "[object Symbol]", Sa = "[object ArrayBuffer]", Ca = "[object DataView]", ft = P ? P.prototype : void 0, ge = ft ? ft.valueOf : void 0;
...
function Qs(e, t, n) {
  ...
  const g = fs(() => import("./mentions-CGqW_Jgp.js"));
  let {
    gradio: p
  } = t, {
    props: c = {}
  ...
  return e.$$set = (_) => {
    t = Oe(Oe({}, t), Ls(_)), n(20, i = bt(t, r)), "gradio" in _ && n(7, p = _.gradio), "props" in _ && n(8, c = _.props), "_internal" in _ && n(9, m = _._internal), "value" in _ && n(0, h = _.value), "as_item" in _ && n(10, f = _.as_item), "visible" in _ && n(11, b = _.visible), "elem_id" in _ && n(12, T = _.elem_id), "elem_classes" in _ && n(13, w = _.elem_classes), "elem_style" in _ && n(14, S = _.elem_style), "$$scope" in _ && n(18, l = _.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    256 && d.update((_) => ({
      ..._,
  ...
  }, [h, a, s, g, d, E, Ke, p, c, m, f, b, T, w, S, o, u, rn, l];
}
class eu extends xs {
  constructor(t) {
