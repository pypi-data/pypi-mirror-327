...
function Wa(e) {
  return typeof e == "function" ? e : e == null ? Ot : typeof e == "object" ? $(e) ? Ya(e[0], e[1]) : Ua(e) : Za(e);
}
function Qa(e) {
...
function Ws(e, t, n) {
  ...
  const d = ls(() => import("./statistic.countdown-D2Rx2osF.js"));
  let {
    gradio: p
  } = t, {
    _internal: f = {}
  ...
  return de(e, Ke, (h) => n(0, a = h)), e.$$set = (h) => {
    t = we(we({}, t), Fs(h)), n(19, i = bt(t, r)), "gradio" in h && n(6, p = h.gradio), "_internal" in h && n(7, f = h._internal), "as_item" in h && n(8, g = h.as_item), "props" in h && n(9, m = h.props), "value" in h && n(10, _ = h.value), "elem_id" in h && n(11, b = h.elem_id), "elem_classes" in h && n(12, T = h.elem_classes), "elem_style" in h && n(13, O = h.elem_style), "visible" in h && n(14, S = h.visible), "$$scope" in h && n(17, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    512 && c.update((h) => ({
      ...h,
  ...
  }, [a, s, d, c, E, Ke, p, f, g, m, _, b, T, O, S, o, u, l];
}
class ks extends Cs {
  constructor(t) {
