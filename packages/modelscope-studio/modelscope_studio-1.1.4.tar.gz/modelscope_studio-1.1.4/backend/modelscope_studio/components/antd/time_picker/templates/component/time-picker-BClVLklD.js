import { i as we, a as H, r as be, g as Ie, w as A, b as Ee } from "./Index-8HXDpkQq.js";
...
function Me(e, t, o) {
  var l, i, n, r, s, u, h = 0, g = !1, c = !1, v = !0;
  if (typeof e != "function")
    throw new TypeError(Ae);
  t = X(t) || 0, H(o) && (g = !!o.leading, c = "maxWait" in o, n = c ? De(X(o.maxWait) || 0, t) : n, v = "trailing" in o ? !!o.trailing : v);
  function m(d) {
    var I = l, S = i;
    return l = i = void 0, h = d, r = e.apply(S, I), r;
  }
  function y(d) {
    return h = d, s = setTimeout(p, t), g ? m(d) : r;
  }
  function b(d) {
    var I = d - u, S = d - h, N = t - I;
    return c ? We(N, n - S) : N;
  }
  function f(d) {
    var I = d - u, S = d - h;
  ...
  function x() {
    s !== void 0 && clearTimeout(s), h = 0, l = u = i = s = void 0;
  }
  function a() {
  ...
  function R() {
    ...
    if (l = arguments, i = this, u = d, I) {
      if (s === void 0)
        return y(u);
      if (c)
        return clearTimeout(s), s = setTimeout(p, t), m(u);
    }
...
const E = xe(({
  ...
  }, [e, g, o, l, n, i]), C.createElement("react-child", {
    ref: r,
    style: {
      display: "contents"
    }
...
const wt = dt(({
  ...
  const a = L(t), R = L(o), d = L(v), I = L(g), S = L(c), N = P(() => l ? T(l) : void 0, [l]), fe = P(() => i ? T(i) : void 0, [i]), me = P(() => n ? T(n) : void 0, [n]), _e = P(() => r ? T(r) : void 0, [r]), pe = P(() => u ? T(u) : void 0, [u]), he = P(() => h ? T(h) : void 0, [h]);
