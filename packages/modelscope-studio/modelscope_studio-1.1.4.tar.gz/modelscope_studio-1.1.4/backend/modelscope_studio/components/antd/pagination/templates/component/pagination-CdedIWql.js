import { i as ae, a as N, r as ue, g as de, w as P, b as fe } from "./Index-BCA_KwD4.js";
...
var D = NaN, ye = /^[-+]0x[0-9a-f]+$/i, xe = /^0b[01]+$/i, Ee = /^0o[0-7]+$/i, ve = parseInt;
function U(e) {
  if (typeof e == "number")
    return e;
  if (ae(e))
  ...
  e = be(e);
  var o = xe.test(e);
  return o || Ee.test(e) ? ve(e.slice(2), o ? 2 : 8) : ye.test(e) ? D : +e;
}
var j = function() {
  return ue.Date.now();
...
function Re(e, t, o) {
  ...
  function m(d) {
    var x = s, R = i;
    return s = i = void 0, _ = d, r = e.apply(R, x), r;
  }
  function E(d) {
    return _ = d, l = setTimeout(h, t), g ? m(d) : r;
  }
  function v(d) {
    var x = d - u, R = d - _, B = t - x;
    return c ? Ie(B, n - R) : B;
  }
  function f(d) {
    var x = d - u, R = d - _;
...
const V = window.ms_globals.rerender, L = window.ms_globals.tree;
function $e(e, t = {}) {
  function o(s) {
    const i = P(), n = new Ze({
      ...s,
