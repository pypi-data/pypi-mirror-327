...
var Ia = 1, ft = "[object Arguments]", pt = "[object Array]", k = "[object Object]", Fa = Object.prototype, gt = Fa.hasOwnProperty;
...
function Zs(e, t, n) {
  ...
  const g = us(() => import("./prompts-DHw1tzpi.js"));
  let {
    gradio: p
  } = t, {
    props: f = {}
  ...
  return de(e, Ke, (b) => n(1, s = b)), e.$$set = (b) => {
    t = Oe(Oe({}, t), Fs(b)), n(18, i = bt(t, r)), "gradio" in b && n(6, p = b.gradio), "props" in b && n(7, f = b.props), "_internal" in b && n(8, m = b._internal), "as_item" in b && n(9, _ = b.as_item), "visible" in b && n(10, c = b.visible), "elem_id" in b && n(11, h = b.elem_id), "elem_classes" in b && n(12, T = b.elem_classes), "elem_style" in b && n(13, w = b.elem_style), "$$scope" in b && n(16, l = b.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && d.update((b) => ({
      ...b,
