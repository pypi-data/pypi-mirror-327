 ...
 */
var _r = x, wr = Symbol.for("react.element"), Tr = Symbol.for("react.fragment"), Mr = Object.prototype.hasOwnProperty, Pr = _r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, Or = {
  key: !0,
  ref: !0,
  __self: !0,
  __source: !0
...
const Qr = "1.0.5", Yr = /* @__PURE__ */ x.createContext({}), Jr = {
  classNames: {},
  styles: {},
  className: "",
  style: {}
}, Zr = (e) => {
  const t = x.useContext(Yr);
  return x.useMemo(() => ({
    ...Jr,
    ...t[e]
  }), [t[e]]);
...
function so(e, t) {
  ...
  }), c = H(a, 2), l = c[0], f = c[1], u = n !== void 0 ? n : l, d = s ? s(u) : u, h = ge(i), v = ve([u]), g = H(v, 2), m = g[0], y = g[1];
  qt(function() {
    var w = m[0];
    l !== w && h(l, w);
  }, [m]), qt(function() {
...
function $o(e, t, r, o) {
  var n = o.motionEnter, i = n === void 0 ? !0 : n, s = o.motionAppear, a = s === void 0 ? !0 : s, c = o.motionLeave, l = c === void 0 ? !0 : c, f = o.motionDeadline, u = o.motionLeaveImmediately, d = o.onAppearPrepare, h = o.onEnterPrepare, v = o.onLeavePrepare, g = o.onAppearStart, m = o.onEnterStart, y = o.onLeaveStart, S = o.onAppearActive, w = o.onEnterActive, b = o.onLeaveActive, _ = o.onAppearEnd, p = o.onEnterEnd, M = o.onLeaveEnd, T = o.onVisibleChanged, R = ve(), L = H(R, 2), I = L[0], A = L[1], $ = _o(Z), j = H($, 2), z = j[0], V = j[1], te = ve(null), J = H(te, 2), ye = J[0], be = J[1], B = z(), ne = ee(!1), me = ee(null);
  function G() {
    return r();
  }
  var re = ee(!1);
  ...
  var Q = ge(function(N) {
    ...
    if (F !== Z) {
      ...
      if (!(N && !N.deadline && N.target !== K)) {
        ...
        F === Me && we ? Te = _ == null ? void 0 : _(K, N) : F === Pe && we ? Te = p == null ? void 0 : p(K, N) : F === Oe && we && (Te = M == null ? void 0 : M(K, N)), we && Te !== !1 && Se();
      }
    }
  ...
  An(function() {
    if (!(ne.current && It.current === t)) {
      ...
      var K = Ee(F);
      F && (e || K[W]) ? (V(F), Wn()) : V(Z), It.current = t;
    }
  }, [t]), pe(function() {
    // Cancel appear
    (B === Me && !a || // Cancel enter
  ...
  var Je = P.useRef(!1);
  pe(function() {
    I && (Je.current = !0), I !== void 0 && B === Z && ((Je.current || I) && (T == null || T(I)), Je.current = !0);
  }, [I, B]);
  var Ze = ye;
...
function jo(e) {
  ...
  var o = /* @__PURE__ */ P.forwardRef(function(n, i) {
    var s = n.visible, a = s === void 0 ? !0 : s, c = n.removeOnLeave, l = c === void 0 ? !0 : c, f = n.forceRender, u = n.children, d = n.motionName, h = n.leavedClassName, v = n.eventProps, g = P.useContext(xo), m = g.motion, y = r(n, m), S = ee(), w = ee();
    function b() {
      try {
    ...
    var _ = $o(y, a, b, n), p = H(_, 4), M = p[0], T = p[1], R = p[2], L = p[3], I = P.useRef(L);
    L && (I.current = !0);
    var A = P.useCallback(function(J) {
      S.current = J, ho(i, J);
    }, [i]), $, j = C(C({}, v), {}, {
      visible: a
    });
  ...
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Fn, r = /* @__PURE__ */ function(o) {
    ...
    return de(i, [{
      ...
      value: function() {
        ...
        l.onAllRemoved;
        var h = Jt(l, ko), v = f || P.Fragment, g = {};
        return Ho.forEach(function(m) {
          g[m] = h[m], delete h[m];
        }), delete h.keys, /* @__PURE__ */ P.createElement(v, h, c.map(function(m, y) {
          var S = m.status, w = Jt(m, Fo), b = S === St || S === xt;
...
function Zo(e) {
  ...
  function c(d, h, v, g) {
    ...
    return function(T) {
      var R = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : T, L = p(T, R), I = H(L, 2), A = I[1], $ = M(R), j = H($, 2), z = j[0], V = j[1];
      return [z, A, V];
    };
  }
  function l(d, h, v) {
  ...
  function f(d, h, v) {
    var g = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, m = Array.isArray(d) ? d : [d, d], y = H(m, 1), S = y[0], w = m.join("-"), b = e.layer || {
      name: "antd"
    };
    return function(_) {
      var p = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : _, M = o(), T = M.theme, R = M.realToken, L = M.hashId, I = M.token, A = M.cssVar, $ = n(), j = $.rootPrefixCls, z = $.iconPrefixCls, V = r(), te = A ? "css" : "js", J = Yo(function() {
...
function ci() {
  const {
    ...
    override: o,
    cssVar: n
  } = x.useContext(pt._internalContext), [i, s, a] = lr(r, [pt.defaultSeed, e], {
    salt: `${Qr}-${t || ""}`,
    override: o,
    getComputedToken: Bn,
    cssVar: n && {
...
const {
  genStyleHooks: li,
  genComponentStyleHook: ji,
  genSubStyleComponent: zi
} = Zo({
  usePrefix: () => {
    const {
      getPrefixCls: e,
...
const Xn = /* @__PURE__ */ x.createContext(null), bi = (e) => {
  const {
    info: t = {},
    nextStatus: r,
    onClick: o,
  ...
  return /* @__PURE__ */ x.createElement("div", ue({}, i, {
    ...
    className: `${p}-title`
  }, c && S && (f === "rtl" ? /* @__PURE__ */ x.createElement(ur, {
    className: `${p}-collapse-icon`,
    rotate: T ? -90 : 0
  }) : /* @__PURE__ */ x.createElement(fr, {
    className: `${p}-collapse-icon`,
    rotate: T ? 90 : 0
  ...
  const {
    ...
    getPrefixCls: d,
    direction: h
  } = vt(), v = d(), g = d("thought-chain", t), m = Zr("thoughtChain"), [y, S, w, b] = vi(i, g, v), [_, p, M] = _i(g), T = X(o, r, g, m.className, p, M, {
    [`${g}-rtl`]: h === "rtl"
  }, `${g}-${l}`);
  return _(/* @__PURE__ */ x.createElement("div", ue({}, u, {
    ...
    var I;
    return /* @__PURE__ */ x.createElement(bi, {
      key: R.key || `key_${L}`,
...
const pn = Yn(({
  ...
  }, [e, f, r, o, i, n]), x.createElement("react-child", {
    ref: s,
    style: {
      display: "contents"
    }
...
const {
  useItems: Ii,
  withItemsContextProvider: Ai,
  ItemHandler: Di
} = or("antdx-thought-chain-items"), ki = qr(Ai(["default", "items"], ({
  children: e,
  items: t,
  ...r
}) => {
  const {
    items: o
  } = Ii(), n = o.items.length > 0 ? o.items : o.default;
