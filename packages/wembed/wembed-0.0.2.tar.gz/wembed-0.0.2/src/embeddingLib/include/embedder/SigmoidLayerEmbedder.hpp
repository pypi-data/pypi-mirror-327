...
class SigmoidLayerEmbedder : public AbstractSimpleEmbedder {
   public:
    SigmoidLayerEmbedder(OptionValues opts, GraphHierarchy *h, int level) : AbstractSimpleEmbedder(opts, h, level){};
