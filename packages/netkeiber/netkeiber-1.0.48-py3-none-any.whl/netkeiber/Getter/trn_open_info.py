            ...
            if tables:
                ...
                for index in range(len(tables)):
                    ...
                    try:
                        ...
                        # 勝ち馬騎手ID
                        win_jockey = str(row[3].find_all("a")[1].get("href")).split("/")[4]
                        # 2着馬ID
                        snd_horse = str(row[4].find_all("a")[0].get("href")).split("/")[2]
                        # 2着馬騎手ID
                        snd_jockey = str(row[4].find_all("a")[1].get("href")).split("/")[4]
                        # 3着馬ID
                        trd_horse = str(row[5].find_all("a")[0].get("href")).split("/")[2]
                        # 3着馬騎手ID
                        trd_jockey = str(row[5].find_all("a")[1].get("href")).split("/")[4]
