...
class MXLogger:
    ...
    def debug(self, msg: str, color: str = None, on_color=None) -> None:
        self._log_print(msg, color=color, on_color=on_color, mode=LogLevel.DEBUG)

    def info(self, msg: str, color: str = 'cyan', on_color=None) -> None:
        self._log_print(msg, color=color, on_color=on_color, mode=LogLevel.INFO)

    def warning(self, msg: str, color: str = 'yellow', on_color=None) -> None:
        self._log_print(msg, color=color, on_color=on_color, mode=LogLevel.WARN)

    def error(self, msg: str, color: str = 'red', on_color=None) -> None:
        self._log_print(msg, color=color, on_color=on_color, mode=LogLevel.ERROR)

    def critical(self, msg: str, color: str = None, on_color='on_red') -> None:
...
def MXLOG_DEBUG(msg: str, color: str = None, on_color: str = None) -> None:
    ...
    logger.debug(msg, color=color, on_color=on_color)
...
def MXLOG_INFO(msg: str, color: str = 'cyan', on_color: str = None, success: bool = None) -> None:
    ...
    if success == None:
        logger.info(msg, color=color, on_color=on_color)
    elif success:
        logger.info(msg, color='green', on_color=on_color)
    else:
        logger.info(msg, color='red', on_color=on_color)
...
def MXLOG_WARN(msg: str, color: str = 'yellow', on_color: str = None) -> None:
    ...
    logger.warning(msg, color=color, on_color=on_color)
...
def MXLOG_ERROR(msg: str, color: str = 'red', on_color: str = None) -> None:
    ...
    logger.error(msg, color=color, on_color=on_color)
...
def MXLOG_CRITICAL(msg: str, color: str = None, on_color: str = 'on_red') -> None:
    ...
    logger.critical(msg, color=color, on_color=on_color)
