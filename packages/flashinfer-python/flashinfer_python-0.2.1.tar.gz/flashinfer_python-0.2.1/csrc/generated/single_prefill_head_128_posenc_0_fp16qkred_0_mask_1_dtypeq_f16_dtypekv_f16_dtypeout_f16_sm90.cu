...
template cudaError_t SinglePrefillWithKVCacheDispatched
    <128, MaskMode::kCausal, /*USE_SWA=*/true, LogitsSoftCap<Params>>
    (Params& params, cudaStream_t stream);

template cudaError_t SinglePrefillWithKVCacheDispatched
    <128, MaskMode::kCausal, /*USE_SWA=*/false, LogitsSoftCap<Params>>
    (Params& params, cudaStream_t stream);

template cudaError_t SinglePrefillWithKVCacheDispatched
    <128, MaskMode::kCausal, /*USE_SWA=*/true, StandardAttention<Params>>
    (Params& params, cudaStream_t stream);

template cudaError_t SinglePrefillWithKVCacheDispatched
    <128, MaskMode::kCausal, /*USE_SWA=*/false, StandardAttention<Params>>
    (Params& params, cudaStream_t stream);
