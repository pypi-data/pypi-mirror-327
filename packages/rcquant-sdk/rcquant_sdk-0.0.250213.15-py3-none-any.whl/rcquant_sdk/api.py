...
def findata_conncet(host: str = None, port: int = None, timeout: int = 30000):
...
def set_findata_auth_params(userid, password, host: str = None, port: int = None, timeout: int = 30000):
    '''
    设置登录信息
    :param userid:用户名
    :param password:密码
