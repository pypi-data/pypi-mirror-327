...
class Mater(_MaterProcessNonPhysical):
    ...
    def run(self, params: Parameter):
        ...
        self.set_time(params.simulation_start_time, params.simulation_end_time, params.time_frequency)
        ...
        date_range = pd.date_range(
            start=self.simulation_start_time, end=self.simulation_end_time, freq=self.time_frequency
        )
    ...
    def set_time(
        ...
        self.simulation_start_time = pd.to_datetime(str(simulation_start_time))
        self.simulation_end_time = pd.to_datetime(str(simulation_end_time))
