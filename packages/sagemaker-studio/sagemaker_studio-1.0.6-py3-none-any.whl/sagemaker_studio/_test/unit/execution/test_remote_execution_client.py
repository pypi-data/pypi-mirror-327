...
class TestRemoteExecutionClient(unittest.TestCase):
    ...
    def test_list_executions(self):
        ...
        # test list_executions
        response = self.remote_client.list_executions(ListExecutionsRequest())
    ...
    def test_stop_execution_failed_status(self):
        ...
        request = StopExecutionRequest(execution_id="test_job_id")

        # Act and Assert
        with self.assertRaises(ConflictError) as context:
            self.remote_client.stop_execution(request)
    ...
    def test_start_execution_happy_path(self, mock_uuid):
        ...
        # Act
        result = self.remote_client.start_execution(request)
