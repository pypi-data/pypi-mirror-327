...
class NotionPageExporter:
    ...
    def _rendering_page(
        self, *, page_id: str, rendering_mode: RenderingMode
    ) -> tuple[Page, str]:
        ...
        *,
        ...
        if page_id is None:
            if include_subpages:
                ...
                return Path(self.root_output_dir) / self.docs_node.name
            else:
            ...
            if include_subpages:
                ...
                # page, file_content = self._generate_tag_string(
                #     page_id=page_id, rendering_mode=file_type
                # )
