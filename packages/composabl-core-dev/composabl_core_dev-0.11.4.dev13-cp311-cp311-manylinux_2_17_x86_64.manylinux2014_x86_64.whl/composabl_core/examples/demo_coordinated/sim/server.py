...
from composabl_core.examples.demo_coordinated.sim.server_impl import ServerImpl
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--protocol", default="grpc", help="Protocol to use (e.g., grpc)"
    )
    parser.add_argument(
        "--env_init",
        type=str,
        default="{}",
        help="Environment initialization (e.g., {})",
    )
