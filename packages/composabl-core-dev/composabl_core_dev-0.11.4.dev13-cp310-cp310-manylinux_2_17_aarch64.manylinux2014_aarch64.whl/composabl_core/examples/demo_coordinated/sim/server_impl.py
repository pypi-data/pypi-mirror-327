...
from composabl_core.examples.demo_coordinated.sim.sim import Sim
...
class ServerImpl(ServerComposabl):
    ...
    async def make(self, env_id: str, env_init: dict):
        ...
        return {"id": "my_simulator", "max_episode_steps": 1000}
    ...
    async def get_render(self):
        return f"Counter: {self.env._get_sensor_values()['state1']}"
