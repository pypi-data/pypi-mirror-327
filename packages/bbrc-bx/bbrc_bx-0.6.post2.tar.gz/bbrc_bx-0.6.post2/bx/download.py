    ...
    for e in tqdm(experiments):
        ...
        try:
            ...
            if subfunc == 'aparc':
                ...
                volumes = pd.DataFrame([cl], columns=[subfunc])
            elif subfunc == 'landau':
                landau = r.landau_signature(optimized=False)
                volumes = pd.DataFrame([landau], columns=[subfunc])
            elif subfunc == 'pet_hammers':
                volumes = r.regional_quantification(optimized=True, atlas='hammers')
            elif subfunc == 'pet_aal':
                volumes = r.regional_quantification(optimized=True, atlas='aal')
