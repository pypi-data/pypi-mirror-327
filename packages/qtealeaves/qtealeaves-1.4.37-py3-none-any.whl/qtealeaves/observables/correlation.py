...
class TNObsCorr(_TNObsBase):
    ...
    **Arguments**
    ...
    def to_itpo(self, operators, tensor_backend, num_sites, de_layer=None):
        """
        Return an ITPO representing the correlation observable.
        ...
        return self._to_itpo_de_layer(operators, tensor_backend, num_sites, de_layer)
        ...
        **Arguments**
        ...
        for ii in range(len(self)):
            if len(self.operators[ii]) != 2:
                raise QTeaLeavesError("Correlation requires two operators")
