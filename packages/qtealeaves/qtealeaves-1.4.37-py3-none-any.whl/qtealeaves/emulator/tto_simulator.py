...
class TTO(TTN):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if "sectors" in kwargs:
            raise QTeaLeavesError("Input ignored.")
    ...
    def log_negativity(self, sqrt=False, local_dim=2):
        """
        Logarithmic negativity
        """

        neg = self.negativity(sqrt=sqrt)
        tlog = self[0, 0].get_attr("log")
        ...
        return float(self[0][0].get_of(log_neg))
    ...
    def get_eigenstates(self, eigen_num_ll):
        ...
        for state_idx in eigen_num_ll:
            ...
            new_ttn = TTN.from_tensor_list(ll).copy()
    ...
    def kron(self, other, inplace=False, fill_identity=True):
        """
